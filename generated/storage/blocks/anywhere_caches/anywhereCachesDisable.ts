...
const anywhereCachesDisable: AppBlock = {
  name: "Anywhere Caches - Disable",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `b/{bucket}/anywhereCaches/{anywhereCacheId}/disable`;
...
export default anywhereCachesDisable;
