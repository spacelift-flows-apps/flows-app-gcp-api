...
const defaultObjectAccessControlsInsert: AppBlock = {
  name: "Default Object Access Controls - Insert",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `b/{bucket}/defaultObjectAcl`;
...
export default defaultObjectAccessControlsInsert;
