...
const bucketsLockRetentionPolicy: AppBlock = {
  name: "Buckets - Lock Retention Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `b/{bucket}/lockRetentionPolicy`;
...
export default bucketsLockRetentionPolicy;
