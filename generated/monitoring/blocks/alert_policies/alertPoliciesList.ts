  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v3/{+name}/alertPolicies`;
      ...
      type: {
        ...
        properties: {
          ...
          totalSize: {
            type: "integer",
            description:
              "The total number of alert policies in all pages. This number is only an estimate, and may change in subsequent pages. https://aip.dev/158 (Format: int32)",
          },
        },
