...
const getUptimeCheckConfig: AppBlock = {
  name: "Get Uptime Check Config",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await new Promise<any>((resolve, reject) => {
          client.getUptimeCheckConfig(request, (err: any, response: any) => {
            if (err)
              reject(
                new Error(
...
export default getUptimeCheckConfig;
