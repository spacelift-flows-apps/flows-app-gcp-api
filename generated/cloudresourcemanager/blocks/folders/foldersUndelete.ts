...
const foldersUndelete: AppBlock = {
  name: "Folders - Undelete",
  description: `Cancels the deletion request for a folder.`,
  category: "Folders",
  inputs: {
    default: {
      config: {
...
export default foldersUndelete;
