  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.destinationParent !== undefined)
          requestBody.destinationParent =
            input.event.inputConfig.destinationParent;
