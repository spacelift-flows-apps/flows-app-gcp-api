...
const testIamPermissions: AppBlock = {
  name: "Operations - Test IAM Permissions",
  description: `Returns permissions that a caller has on the specified project, in the format 'projects/{ProjectIdOrNumber}' e.`,
  category: "Operations",
  inputs: {
    default: {
      config: {
