...
const disableSecretVersion: AppBlock = {
  name: "Disable Secret Version",
  description: `Disables a [SecretVersion][google.cloud.secretmanager.v1.SecretVersion]. Sets the [state][google.cloud.secretmanager.v1.SecretVersion.state] of the [SecretVersion][google.cloud.secretmanager.v1.SecretVersion] to [DISABLED][google.cloud.secretmanager.v1.SecretVersion.State.DISABLED].`,
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await new Promise<any>((resolve, reject) => {
          client.disableSecretVersion(request, (err: any, response: any) => {
            if (err)
              reject(
                new Error(
...
export default disableSecretVersion;
