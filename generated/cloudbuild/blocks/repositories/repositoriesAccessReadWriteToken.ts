...
const repositoriesAccessReadWriteToken: AppBlock = {
  name: "Repositories - Access Read Write Token",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v2/{+repository}:accessReadWriteToken`;
...
export default repositoriesAccessReadWriteToken;
