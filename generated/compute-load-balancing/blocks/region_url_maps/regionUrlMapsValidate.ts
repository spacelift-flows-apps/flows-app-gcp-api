...
const regionUrlMapsValidate: AppBlock = {
  name: "Region URL Maps - Validate",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/urlMaps/{urlMap}/validate`;
...
export default regionUrlMapsValidate;
