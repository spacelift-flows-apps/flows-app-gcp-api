...
const regionTargetTcpProxiesInsert: AppBlock = {
  name: "Region Target TCP Proxies - Insert",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/targetTcpProxies`;
        ...
        if (input.event.inputConfig.proxyHeader !== undefined)
          requestBody.proxyHeader = input.event.inputConfig.proxyHeader;
        ...
        if (input.event.inputConfig.service !== undefined)
          requestBody.service = input.event.inputConfig.service;
...
export default regionTargetTcpProxiesInsert;
