...
const regionTargetTcpProxiesDelete: AppBlock = {
  name: "Region Target TCP Proxies - Delete",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/targetTcpProxies/{targetTcpProxy}`;
...
export default regionTargetTcpProxiesDelete;
