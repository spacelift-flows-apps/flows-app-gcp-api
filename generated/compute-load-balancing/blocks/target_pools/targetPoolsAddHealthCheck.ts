...
const targetPoolsAddHealthCheck: AppBlock = {
  name: "Target Pools - Add Health Check",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/targetPools/{targetPool}/addHealthCheck`;
...
export default targetPoolsAddHealthCheck;
