...
const targetPoolsRemoveInstance: AppBlock = {
  name: "Target Pools - Remove Instance",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/targetPools/{targetPool}/removeInstance`;
...
export default targetPoolsRemoveInstance;
