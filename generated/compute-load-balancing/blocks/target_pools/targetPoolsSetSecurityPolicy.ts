...
const targetPoolsSetSecurityPolicy: AppBlock = {
  name: "Target Pools - Set Security Policy",
  description: `Sets the Google Cloud Armor security policy for the specified target pool.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/targetPools/{targetPool}/setSecurityPolicy`;
...
export default targetPoolsSetSecurityPolicy;
