...
const targetPoolsRemoveHealthCheck: AppBlock = {
  name: "Target Pools - Remove Health Check",
  ...
  inputs: {
    default: {
      config: {
        ...
        healthChecks: {
          name: "Health Checks",
          description: "Health check URL to be removed.",
          type: {
            type: "array",
            items: {
              type: "object",
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/targetPools/{targetPool}/removeHealthCheck`;
...
export default targetPoolsRemoveHealthCheck;
