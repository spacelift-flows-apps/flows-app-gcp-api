...
const targetPoolsAddInstance: AppBlock = {
  name: "Target Pools - Add Instance",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/targetPools/{targetPool}/addInstance`;
...
export default targetPoolsAddInstance;
