...
const globalForwardingRulesSetTarget: AppBlock = {
  name: "Global Forwarding Rules - Set Target",
  description: `Changes target URL for the GlobalForwardingRule resource.`,
  ...
  inputs: {
    default: {
      config: {
        ...
        target: {
          name: "Target",
          description: "Request body field: target",
          type: {
            type: "string",
          },
          required: false,
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/forwardingRules/{forwardingRule}/setTarget`;
...
export default globalForwardingRulesSetTarget;
