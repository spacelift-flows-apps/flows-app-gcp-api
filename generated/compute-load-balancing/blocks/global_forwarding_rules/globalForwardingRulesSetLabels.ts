...
const globalForwardingRulesSetLabels: AppBlock = {
  name: "Global Forwarding Rules - Set Labels",
  description: `Sets the labels on the specified resource.`,
  ...
  inputs: {
    default: {
      config: {
        ...
        labels: {
          name: "Labels",
          description: "A list of labels to apply for this resource.",
          type: {
            type: "object",
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/forwardingRules/{resource}/setLabels`;
...
export default globalForwardingRulesSetLabels;
