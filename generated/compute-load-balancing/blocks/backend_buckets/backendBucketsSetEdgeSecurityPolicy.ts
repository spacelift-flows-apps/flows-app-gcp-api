...
const backendBucketsSetEdgeSecurityPolicy: AppBlock = {
  name: "Backend Buckets - Set Edge Security Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/backendBuckets/{backendBucket}/setEdgeSecurityPolicy`;
...
export default backendBucketsSetEdgeSecurityPolicy;
