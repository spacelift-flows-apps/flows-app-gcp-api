...
const backendBucketsAddSignedUrlKey: AppBlock = {
  name: "Backend Buckets - Add Signed URL Key",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/backendBuckets/{backendBucket}/addSignedUrlKey`;
...
export default backendBucketsAddSignedUrlKey;
