...
const regionBackendServicesSetSecurityPolicy: AppBlock = {
  name: "Region Backend Services - Set Security Policy",
  description: `Sets the Google Cloud Armor security policy for the specified backend service.`,
    ...
    default: {
      config: {
        ...
        securityPolicy: {
          ...
          description: "Request body field: securityPolicy",
          type: {
            type: "string",
          },
          required: false,
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/backendServices/{backendService}/setSecurityPolicy`;
...
export default regionBackendServicesSetSecurityPolicy;
