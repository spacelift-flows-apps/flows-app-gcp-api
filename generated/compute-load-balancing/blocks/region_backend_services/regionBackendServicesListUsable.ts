...
const regionBackendServicesListUsable: AppBlock = {
  name: "Region Backend Services - List Usable",
      ...
      type: {
        ...
        properties: {
          ...
          kind: {
            type: "string",
            description:
              "Output only. [Output Only] Type of resource. Alwayscompute#usableBackendServiceList for lists of usable backend services.",
          },
          nextPageToken: {
            type: "string",
            description:
...
export default regionBackendServicesListUsable;
