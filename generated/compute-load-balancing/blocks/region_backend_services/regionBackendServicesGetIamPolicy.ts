...
const regionBackendServicesGetIamPolicy: AppBlock = {
  name: "Region Backend Services - Get IAM Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/backendServices/{resource}/getIamPolicy`;
...
export default regionBackendServicesGetIamPolicy;
