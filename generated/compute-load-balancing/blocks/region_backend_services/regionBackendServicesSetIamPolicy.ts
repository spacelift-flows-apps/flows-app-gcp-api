...
const regionBackendServicesSetIamPolicy: AppBlock = {
  name: "Region Backend Services - Set IAM Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/backendServices/{resource}/setIamPolicy`;
...
export default regionBackendServicesSetIamPolicy;
