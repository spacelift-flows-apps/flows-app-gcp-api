...
const regionBackendServicesPatch: AppBlock = {
  name: "Region Backend Services - Patch",
  description: `Updates the specified regional BackendService resource with the data included in the request.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/backendServices/{backendService}`;
...
export default regionBackendServicesPatch;
