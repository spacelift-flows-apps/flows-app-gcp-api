...
const regionBackendServicesInsert: AppBlock = {
  name: "Region Backend Services - Insert",
  description: `Creates a regional BackendService resource in the specified project using the data included in the request.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/backendServices`;
...
export default regionBackendServicesInsert;
