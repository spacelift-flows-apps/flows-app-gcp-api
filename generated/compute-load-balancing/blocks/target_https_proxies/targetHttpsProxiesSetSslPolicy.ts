...
const targetHttpsProxiesSetSslPolicy: AppBlock = {
  name: "Target HTTPS Proxies - Set SSL Policy",
  description: `Sets the SSL policy for TargetHttpsProxy.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/targetHttpsProxies/{targetHttpsProxy}/setSslPolicy`;
...
export default targetHttpsProxiesSetSslPolicy;
