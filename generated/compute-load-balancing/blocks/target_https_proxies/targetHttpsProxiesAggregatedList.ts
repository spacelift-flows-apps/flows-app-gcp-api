...
const targetHttpsProxiesAggregatedList: AppBlock = {
  name: "Target Https Proxies - Aggregated List",
      ...
      type: {
        ...
        properties: {
          ...
          kind: {
            type: "string",
            description:
              "Output only. [Output Only] Type of resource. Alwayscompute#targetHttpsProxyAggregatedList for lists of Target HTTP Proxies.",
          },
          nextPageToken: {
            type: "string",
            description:
...
export default targetHttpsProxiesAggregatedList;
