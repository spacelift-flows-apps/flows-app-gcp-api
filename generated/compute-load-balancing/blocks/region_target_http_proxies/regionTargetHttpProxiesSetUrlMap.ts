...
const regionTargetHttpProxiesSetUrlMap: AppBlock = {
  name: "Region Target HTTP Proxies - Set URL Map",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/targetHttpProxies/{targetHttpProxy}/setUrlMap`;
...
export default regionTargetHttpProxiesSetUrlMap;
