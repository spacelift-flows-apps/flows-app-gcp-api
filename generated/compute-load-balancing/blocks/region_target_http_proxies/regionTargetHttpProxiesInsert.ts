...
const regionTargetHttpProxiesInsert: AppBlock = {
  name: "Region Target HTTP Proxies - Insert",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/targetHttpProxies`;
...
export default regionTargetHttpProxiesInsert;
