...
const backendServicesSetIamPolicy: AppBlock = {
  name: "Backend Services - Set IAM Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/backendServices/{resource}/setIamPolicy`;
...
export default backendServicesSetIamPolicy;
