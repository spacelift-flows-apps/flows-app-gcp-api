...
const backendServicesDeleteSignedUrlKey: AppBlock = {
  name: "Backend Services - Delete Signed Url Key",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.keyName !== undefined)
          queryParams["keyName"] = String(input.event.inputConfig.keyName);
...
export default backendServicesDeleteSignedUrlKey;
