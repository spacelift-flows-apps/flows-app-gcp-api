...
const backendServicesSetEdgeSecurityPolicy: AppBlock = {
  name: "Backend Services - Set Edge Security Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/backendServices/{backendService}/setEdgeSecurityPolicy`;
...
export default backendServicesSetEdgeSecurityPolicy;
