...
const backendServicesSetSecurityPolicy: AppBlock = {
  name: "Backend Services - Set Security Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/backendServices/{backendService}/setSecurityPolicy`;
...
export default backendServicesSetSecurityPolicy;
