...
const backendServicesAddSignedUrlKey: AppBlock = {
  name: "Backend Services - Add Signed URL Key",
  ...
  inputs: {
    default: {
      config: {
        ...
        keyValue: {
          name: "Key Value",
          description: "128-bit key value used for signing the URL.",
          type: {
            type: "string",
            description:
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/backendServices/{backendService}/addSignedUrlKey`;
        ...
        if (input.event.inputConfig.keyValue !== undefined)
          requestBody.keyValue = input.event.inputConfig.keyValue;
        if (input.event.inputConfig.keyName !== undefined)
          requestBody.keyName = input.event.inputConfig.keyName;
...
export default backendServicesAddSignedUrlKey;
