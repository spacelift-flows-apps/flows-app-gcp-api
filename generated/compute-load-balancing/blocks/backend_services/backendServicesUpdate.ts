...
const backendServicesUpdate: AppBlock = {
  name: "Backend Services - Update",
  description: `Updates the specified BackendService resource with the data included in the request.`,
...
export default backendServicesUpdate;
