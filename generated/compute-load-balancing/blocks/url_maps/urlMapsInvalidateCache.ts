...
const urlMapsInvalidateCache: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.cacheTags !== undefined)
          body.cacheTags = input.event.inputConfig.cacheTags;
...
export default urlMapsInvalidateCache;
