...
const urlMapsAggregatedList: AppBlock = {
  name: "Url Maps - Aggregated List",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "GET",
          pathTemplate: "/compute/v1/projects/{project}/aggregated/urlMaps",
          pathParams,
          queryParams,
        });
...
export default urlMapsAggregatedList;
