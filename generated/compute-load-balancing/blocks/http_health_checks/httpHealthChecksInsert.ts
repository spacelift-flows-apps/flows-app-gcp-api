...
const httpHealthChecksInsert: AppBlock = {
  name: "HTTP Health Checks - Insert",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/httpHealthChecks`;
...
export default httpHealthChecksInsert;
