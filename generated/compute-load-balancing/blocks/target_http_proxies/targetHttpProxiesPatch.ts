...
const targetHttpProxiesPatch: AppBlock = {
  name: "Target HTTP Proxies - Patch",
  description: `Patches the specified TargetHttpProxy resource with the data included in the request.`,
...
export default targetHttpProxiesPatch;
