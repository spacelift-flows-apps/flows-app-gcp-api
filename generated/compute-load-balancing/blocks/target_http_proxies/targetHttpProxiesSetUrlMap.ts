...
const targetHttpProxiesSetUrlMap: AppBlock = {
  name: "Target HTTP Proxies - Set URL Map",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/targetHttpProxies/{targetHttpProxy}/setUrlMap`;
...
export default targetHttpProxiesSetUrlMap;
