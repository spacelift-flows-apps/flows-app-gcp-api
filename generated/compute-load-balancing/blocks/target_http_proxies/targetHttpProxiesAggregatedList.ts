...
const targetHttpProxiesAggregatedList: AppBlock = {
  name: "Target Http Proxies - Aggregated List",
      ...
      type: {
        ...
        properties: {
          ...
          kind: {
            type: "string",
            description:
              "Output only. [Output Only] Type of resource. Alwayscompute#targetHttpProxyAggregatedList for lists of Target HTTP Proxies.",
          },
          nextPageToken: {
            type: "string",
            description:
...
export default targetHttpProxiesAggregatedList;
