...
const targetSslProxiesSetSslCertificates: AppBlock = {
  name: "Target SSL Proxies - Set SSL Certificates",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/targetSslProxies/{targetSslProxy}/setSslCertificates`;
...
export default targetSslProxiesSetSslCertificates;
