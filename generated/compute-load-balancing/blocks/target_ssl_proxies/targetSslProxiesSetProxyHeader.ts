...
const targetSslProxiesSetProxyHeader: AppBlock = {
  name: "Target SSL Proxies - Set Proxy Header",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/targetSslProxies/{targetSslProxy}/setProxyHeader`;
...
export default targetSslProxiesSetProxyHeader;
