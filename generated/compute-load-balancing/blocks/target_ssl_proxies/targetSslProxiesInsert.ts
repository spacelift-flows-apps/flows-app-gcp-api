...
const targetSslProxiesInsert: AppBlock = {
  name: "Target SSL Proxies - Insert",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/targetSslProxies`;
...
export default targetSslProxiesInsert;
