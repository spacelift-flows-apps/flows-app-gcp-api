...
const targetSslProxiesSetSslPolicy: AppBlock = {
  name: "Target SSL Proxies - Set SSL Policy",
  description: `Sets the SSL policy for TargetSslProxy.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/targetSslProxies/{targetSslProxy}/setSslPolicy`;
...
export default targetSslProxiesSetSslPolicy;
