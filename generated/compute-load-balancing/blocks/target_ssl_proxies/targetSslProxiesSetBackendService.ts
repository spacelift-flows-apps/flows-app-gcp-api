...
const targetSslProxiesSetBackendService: AppBlock = {
  name: "Target SSL Proxies - Set Backend Service",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/targetSslProxies/{targetSslProxy}/setBackendService`;
...
export default targetSslProxiesSetBackendService;
