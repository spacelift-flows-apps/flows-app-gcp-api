...
const regionTargetHttpsProxiesSetSslCertificates: AppBlock = {
  name: "Region Target Https Proxies - Set Ssl Certificates",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.targetHttpsProxy !== undefined)
          pathParams["target_https_proxy"] = String(
            input.event.inputConfig.targetHttpsProxy,
          );
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/regions/{region}/targetHttpsProxies/{target_https_proxy}/setSslCertificates",
          pathParams,
          queryParams,
...
export default regionTargetHttpsProxiesSetSslCertificates;
