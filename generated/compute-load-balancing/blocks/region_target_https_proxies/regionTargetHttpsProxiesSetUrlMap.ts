...
const regionTargetHttpsProxiesSetUrlMap: AppBlock = {
  name: "Region Target Https Proxies - Set Url Map",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/regions/{region}/targetHttpsProxies/{target_https_proxy}/setUrlMap",
          pathParams,
          queryParams,
...
export default regionTargetHttpsProxiesSetUrlMap;
