...
const regionTargetHttpsProxiesPatch: AppBlock = {
  name: "Region Target HTTPS Proxies - Patch",
  description: `Patches the specified regional TargetHttpsProxy resource with the data included in the request.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/targetHttpsProxies/{targetHttpsProxy}`;
...
export default regionTargetHttpsProxiesPatch;
