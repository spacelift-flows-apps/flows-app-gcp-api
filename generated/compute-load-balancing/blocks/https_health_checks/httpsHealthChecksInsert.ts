...
const httpsHealthChecksInsert: AppBlock = {
  name: "HTTPS Health Checks - Insert",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/httpsHealthChecks`;
        ...
        if (input.event.inputConfig.port !== undefined)
          requestBody.port = input.event.inputConfig.port;
        ...
        if (input.event.inputConfig.requestPath !== undefined)
          requestBody.requestPath = input.event.inputConfig.requestPath;
...
export default httpsHealthChecksInsert;
