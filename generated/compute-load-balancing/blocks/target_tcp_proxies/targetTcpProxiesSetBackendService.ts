...
const targetTcpProxiesSetBackendService: AppBlock = {
  name: "Target TCP Proxies - Set Backend Service",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/targetTcpProxies/{targetTcpProxy}/setBackendService`;
...
export default targetTcpProxiesSetBackendService;
