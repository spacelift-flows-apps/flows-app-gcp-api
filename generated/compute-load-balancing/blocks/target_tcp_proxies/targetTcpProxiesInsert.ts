...
const targetTcpProxiesInsert: AppBlock = {
  name: "Target TCP Proxies - Insert",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/targetTcpProxies`;
...
export default targetTcpProxiesInsert;
