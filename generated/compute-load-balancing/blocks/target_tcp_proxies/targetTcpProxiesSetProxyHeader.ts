...
const targetTcpProxiesSetProxyHeader: AppBlock = {
  name: "Target TCP Proxies - Set Proxy Header",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/targetTcpProxies/{targetTcpProxy}/setProxyHeader`;
...
export default targetTcpProxiesSetProxyHeader;
