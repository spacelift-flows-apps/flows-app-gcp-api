...
const targetTcpProxiesAggregatedList: AppBlock = {
  name: "Target Tcp Proxies - Aggregated List",
      ...
      type: {
        ...
        properties: {
          ...
          kind: {
            type: "string",
            description:
              "Output only. [Output Only] Type of resource. Alwayscompute#targetTcpProxyAggregatedList for lists of Target TCP Proxies.",
          },
          nextPageToken: {
            type: "string",
            description:
...
export default targetTcpProxiesAggregatedList;
