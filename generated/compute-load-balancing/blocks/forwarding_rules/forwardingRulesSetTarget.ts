...
const forwardingRulesSetTarget: AppBlock = {
  name: "Forwarding Rules - Set Target",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/forwardingRules/{forwardingRule}/setTarget`;
...
export default forwardingRulesSetTarget;
