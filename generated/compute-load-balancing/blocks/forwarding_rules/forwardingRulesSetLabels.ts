...
const forwardingRulesSetLabels: AppBlock = {
  name: "Forwarding Rules - Set Labels",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/forwardingRules/{resource}/setLabels`;
...
export default forwardingRulesSetLabels;
