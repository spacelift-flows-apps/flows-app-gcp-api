...
const resourcePoliciesGetIamPolicy: AppBlock = {
  name: "Resource Policies - Get IAM Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/resourcePolicies/{resource}/getIamPolicy`;
...
export default resourcePoliciesGetIamPolicy;
