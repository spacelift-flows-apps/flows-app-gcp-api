...
const resourcePoliciesSetIamPolicy: AppBlock = {
  name: "Resource Policies - Set IAM Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/resourcePolicies/{resource}/setIamPolicy`;
...
export default resourcePoliciesSetIamPolicy;
