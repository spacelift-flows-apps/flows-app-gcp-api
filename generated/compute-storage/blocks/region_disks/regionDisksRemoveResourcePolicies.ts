...
const regionDisksRemoveResourcePolicies: AppBlock = {
  name: "Region Disks - Remove Resource Policies",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/disks/{disk}/removeResourcePolicies`;
...
export default regionDisksRemoveResourcePolicies;
