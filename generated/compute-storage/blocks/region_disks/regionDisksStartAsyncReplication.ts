...
const regionDisksStartAsyncReplication: AppBlock = {
  name: "Region Disks - Start Async Replication",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/disks/{disk}/startAsyncReplication`;
        ...
        if (input.event.inputConfig.asyncSecondaryDisk !== undefined)
          requestBody.asyncSecondaryDisk =
            input.event.inputConfig.asyncSecondaryDisk;
...
export default regionDisksStartAsyncReplication;
