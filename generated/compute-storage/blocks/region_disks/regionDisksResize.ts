...
const regionDisksResize: AppBlock = {
  name: "Region Disks - Resize",
  ...
  inputs: {
    default: {
      config: {
        ...
        sizeGb: {
          ...
          type: {
            type: "string",
            description:
              "The new size of the regional persistent disk, which is specified in GB. (Format: int64)",
          },
          required: false,
        },
      },
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/disks/{disk}/resize`;
...
export default regionDisksResize;
