...
const regionDisksSetLabels: AppBlock = {
  name: "Region Disks - Set Labels",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/disks/{resource}/setLabels`;
...
export default regionDisksSetLabels;
