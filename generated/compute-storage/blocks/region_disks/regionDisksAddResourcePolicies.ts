...
const regionDisksAddResourcePolicies: AppBlock = {
  name: "Region Disks - Add Resource Policies",
  description: `Adds existing resource policies to a regional disk.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/disks/{disk}/addResourcePolicies`;
...
export default regionDisksAddResourcePolicies;
