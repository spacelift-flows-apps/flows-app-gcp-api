...
const regionDisksStopAsyncReplication: AppBlock = {
  name: "Region Disks - Stop Async Replication",
  description: `Stops asynchronous replication.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/disks/{disk}/stopAsyncReplication`;
...
export default regionDisksStopAsyncReplication;
