...
const regionDisksStopGroupAsyncReplication: AppBlock = {
  name: "Region Disks - Stop Group Async Replication",
  description: `Stops asynchronous replication for a consistency group of disks.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/disks/stopGroupAsyncReplication`;
        ...
        if (input.event.inputConfig.resourcePolicy !== undefined)
          requestBody.resourcePolicy = input.event.inputConfig.resourcePolicy;
...
export default regionDisksStopGroupAsyncReplication;
