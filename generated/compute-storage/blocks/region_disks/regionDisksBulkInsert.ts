...
const regionDisksBulkInsert: AppBlock = {
  name: "Region Disks - Bulk Insert",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/disks/bulkInsert`;
...
export default regionDisksBulkInsert;
