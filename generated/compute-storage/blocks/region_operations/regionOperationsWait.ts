...
const regionOperationsWait: AppBlock = {
  name: "Region Operations - Wait",
  description: `Waits for the specified Operation resource to return as 'DONE' or for the request to approach the 2 minute deadline, and retrieves the specified Operation resource.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/operations/{operation}/wait`;
...
export default regionOperationsWait;
