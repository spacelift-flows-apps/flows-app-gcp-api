...
const regionOperationsGet: AppBlock = {
  name: "Region Operations - Get",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/operations/{operation}`;
...
export default regionOperationsGet;
