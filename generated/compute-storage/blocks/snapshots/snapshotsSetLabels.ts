...
const snapshotsSetLabels: AppBlock = {
  name: "Snapshots - Set Labels",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/snapshots/{resource}/setLabels`;
...
export default snapshotsSetLabels;
