...
const snapshotSettingsServicePatch: AppBlock = {
  name: "Snapshot Settings Service - Patch",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.storageLocation !== undefined)
          body.storageLocation = input.event.inputConfig.storageLocation;
...
export default snapshotSettingsServicePatch;
