...
const disksStopGroupAsyncReplication: AppBlock = {
  name: "Disks - Stop Group Async Replication",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/disks/stopGroupAsyncReplication`;
...
export default disksStopGroupAsyncReplication;
