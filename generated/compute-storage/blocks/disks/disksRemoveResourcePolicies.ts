...
const disksRemoveResourcePolicies: AppBlock = {
  name: "Disks - Remove Resource Policies",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/disks/{disk}/removeResourcePolicies`;
...
export default disksRemoveResourcePolicies;
