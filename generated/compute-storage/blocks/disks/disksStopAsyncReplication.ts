...
const disksStopAsyncReplication: AppBlock = {
  name: "Disks - Stop Async Replication",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/disks/{disk}/stopAsyncReplication`;
...
export default disksStopAsyncReplication;
