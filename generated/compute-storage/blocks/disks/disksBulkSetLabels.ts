...
const disksBulkSetLabels: AppBlock = {
  name: "Disks - Bulk Set Labels",
  description: `Sets the labels on many disks at once.`,
  category: "Disks",
  inputs: {
    default: {
      config: {
        ...
        requests: {
          name: "Requests",
          description: "Request body field: requests",
          type: {
            type: "array",
            items: {
              type: "object",
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/disks/bulkSetLabels`;
...
export default disksBulkSetLabels;
