...
const disksGetIamPolicy: AppBlock = {
  name: "Disks - Get IAM Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/disks/{resource}/getIamPolicy`;
...
export default disksGetIamPolicy;
