...
const disksStartAsyncReplication: AppBlock = {
  name: "Disks - Start Async Replication",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/disks/{disk}/startAsyncReplication`;
...
export default disksStartAsyncReplication;
