...
const disksSetIamPolicy: AppBlock = {
  name: "Disks - Set IAM Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/disks/{resource}/setIamPolicy`;
...
export default disksSetIamPolicy;
