  ...
  inputs: {
    default: {
      config: {
        ...
        sizeGb: {
          ...
          type: {
            type: "string",
            description:
              "The new size of the persistent disk, which is specified in GB. (Format: int64)",
          },
          required: false,
        },
      },
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/disks/{disk}/resize`;
