...
const disksAddResourcePolicies: AppBlock = {
  name: "Disks - Add Resource Policies",
  description: `Adds existing resource policies to a disk.`,
  category: "Disks",
  inputs: {
    default: {
      config: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/disks/{disk}/addResourcePolicies`;
...
export default disksAddResourcePolicies;
