...
const instantSnapshotsDelete: AppBlock = {
  name: "Instant Snapshots - Delete",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "DELETE",
          pathTemplate:
            "/compute/v1/projects/{project}/zones/{zone}/instantSnapshots/{instant_snapshot}",
          pathParams,
          queryParams,
        });
...
export default instantSnapshotsDelete;
