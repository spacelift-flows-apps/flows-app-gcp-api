...
const diskTypesAggregatedList: AppBlock = {
  name: "Disk Types - Aggregated List",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "GET",
          pathTemplate: "/compute/v1/projects/{project}/aggregated/diskTypes",
          pathParams,
          queryParams,
        });
...
export default diskTypesAggregatedList;
