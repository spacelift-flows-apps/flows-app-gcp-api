...
const storagePoolsSetIamPolicy: AppBlock = {
  name: "Storage Pools - Set IAM Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/storagePools/{resource}/setIamPolicy`;
...
export default storagePoolsSetIamPolicy;
