  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/storagePools/{storagePool}/listDisks`;
            ...
            items: {
              ...
              properties: {
                usedBytes: {
                  type: "string",
                  description:
                    "[Output Only] Amount of disk space used. (Format: int64)",
                },
                type: {
                  type: "string",
                ...
                provisionedIops: {
                  type: "string",
                  description:
                    "[Output Only] The number of IOPS provisioned for the disk. (Format: int64)",
                },
                attachedInstances: {
                  type: "array",
                  items: {
                ...
                provisionedThroughput: {
                  type: "string",
                  description:
                    "[Output Only] The throughput provisioned for the disk. (Format: int64)",
                },
                sizeGb: {
                  type: "string",
                  description:
                    "[Output Only] The disk size, in GB. (Format: int64)",
                },
                status: {
                  type: "string",
                  enum: [
