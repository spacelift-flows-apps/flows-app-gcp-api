...
const storagePoolsAggregatedList: AppBlock = {
  name: "Storage Pools - Aggregated List",
      ...
      type: {
        ...
        properties: {
          ...
          kind: {
            type: "string",
            description:
              "Output only. [Output Only] Type of resource. Alwayscompute#storagePoolAggregatedList for aggregated lists of storage pools.",
          },
          nextPageToken: {
            type: "string",
            description:
...
export default storagePoolsAggregatedList;
