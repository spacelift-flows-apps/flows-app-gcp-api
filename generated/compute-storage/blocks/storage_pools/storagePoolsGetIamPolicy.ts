...
const storagePoolsGetIamPolicy: AppBlock = {
  name: "Storage Pools - Get IAM Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/storagePools/{resource}/getIamPolicy`;
...
export default storagePoolsGetIamPolicy;
