...
const imagesGetIamPolicy: AppBlock = {
  name: "Images - Get IAM Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/images/{resource}/getIamPolicy`;
...
export default imagesGetIamPolicy;
