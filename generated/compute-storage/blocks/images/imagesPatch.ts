...
const imagesPatch: AppBlock = {
  name: "Images - Patch",
  description: `Patches the specified image with the data included in the request.`,
  category: "Images",
  inputs: {
    default: {
      config: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/images/{image}`;
