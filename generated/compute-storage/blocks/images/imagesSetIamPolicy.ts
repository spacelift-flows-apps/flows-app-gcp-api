...
const imagesSetIamPolicy: AppBlock = {
  name: "Images - Set IAM Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/images/{resource}/setIamPolicy`;
...
export default imagesSetIamPolicy;
