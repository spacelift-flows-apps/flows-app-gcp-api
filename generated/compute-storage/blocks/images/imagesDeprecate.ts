  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/images/{image}/deprecate`;
        ...
        if (input.event.inputConfig.obsolete !== undefined)
          requestBody.obsolete = input.event.inputConfig.obsolete;
        if (input.event.inputConfig.deleted !== undefined)
          requestBody.deleted = input.event.inputConfig.deleted;
