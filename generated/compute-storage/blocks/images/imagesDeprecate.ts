...
const imagesDeprecate: AppBlock = {
  name: "Images - Deprecate",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.deleted !== undefined)
          body.deleted = input.event.inputConfig.deleted;
        if (input.event.inputConfig.deprecated !== undefined)
          body.deprecated = input.event.inputConfig.deprecated;
        if (input.event.inputConfig.obsolete !== undefined)
          body.obsolete = input.event.inputConfig.obsolete;
        if (input.event.inputConfig.replacement !== undefined)
          body.replacement = input.event.inputConfig.replacement;
...
export default imagesDeprecate;
