...
const functionsAbortFunctionUpgrade: AppBlock = {
  name: "Functions - Abort Function Upgrade",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v2/{+name}:abortFunctionUpgrade`;
...
export default functionsAbortFunctionUpgrade;
