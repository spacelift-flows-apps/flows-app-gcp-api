      ...
      type: {
        ...
        properties: {
          ...
          updateTime: {
            type: "string",
            description:
              "Output only. The last update timestamp of a Cloud Function. (Format: google-datetime)",
          },
          labels: {
            type: "object",
            additionalProperties: {
          ...
          createTime: {
            type: "string",
            description:
              "Output only. The create timestamp of a Cloud Function. This is only applicable to 2nd Gen functions. (Format: google-datetime)",
          },
          satisfiesPzi: {
            type: "boolean",
            description: "Output only. Reserved for future use.",
