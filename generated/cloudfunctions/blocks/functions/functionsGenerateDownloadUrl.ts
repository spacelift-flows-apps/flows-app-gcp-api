...
const functionsGenerateDownloadUrl: AppBlock = {
  name: "Functions - Generate Download URL",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v2/{+name}:generateDownloadUrl`;
...
export default functionsGenerateDownloadUrl;
