...
const publicAdvertisedPrefixesAnnounce: AppBlock = {
  name: "Public Advertised Prefixes - Announce",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/global/publicAdvertisedPrefixes/{public_advertised_prefix}/announce",
          pathParams,
          queryParams,
        });
...
export default publicAdvertisedPrefixesAnnounce;
