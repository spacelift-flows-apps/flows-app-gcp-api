...
const publicAdvertisedPrefixesWithdraw: AppBlock = {
  name: "Public Advertised Prefixes - Withdraw",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/global/publicAdvertisedPrefixes/{public_advertised_prefix}/withdraw",
          pathParams,
          queryParams,
        });
...
export default publicAdvertisedPrefixesWithdraw;
