...
const interconnectAttachmentsSetLabels: AppBlock = {
  name: "Interconnect Attachments - Set Labels",
  description: `Sets the labels on an InterconnectAttachment.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/interconnectAttachments/{resource}/setLabels`;
...
export default interconnectAttachmentsSetLabels;
