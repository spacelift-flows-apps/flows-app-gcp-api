...
const subnetworksSetPrivateIpGoogleAccess: AppBlock = {
  name: "Subnetworks - Set Private IP Google Access",
    ...
    default: {
      config: {
        ...
        privateIpGoogleAccess: {
          ...
          description: "Request body field: privateIpGoogleAccess",
          type: {
            type: "boolean",
          },
          required: false,
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/subnetworks/{subnetwork}/setPrivateIpGoogleAccess`;
...
export default subnetworksSetPrivateIpGoogleAccess;
