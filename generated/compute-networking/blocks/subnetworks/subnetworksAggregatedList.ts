...
const subnetworksAggregatedList: AppBlock = {
  name: "Subnetworks - Aggregated List",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "GET",
          pathTemplate: "/compute/v1/projects/{project}/aggregated/subnetworks",
          pathParams,
          queryParams,
        });
      ...
      type: {
        ...
        properties: {
          ...
          kind: {
            type: "string",
            description:
              "Output only. [Output Only] Type of resource. Alwayscompute#subnetworkAggregatedList for aggregated lists of subnetworks.",
          },
          nextPageToken: {
            type: "string",
            description:
...
export default subnetworksAggregatedList;
