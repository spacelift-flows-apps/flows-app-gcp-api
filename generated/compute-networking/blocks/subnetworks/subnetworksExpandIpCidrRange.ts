...
const subnetworksExpandIpCidrRange: AppBlock = {
  name: "Subnetworks - Expand IP Cidr Range",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/subnetworks/{subnetwork}/expandIpCidrRange`;
...
export default subnetworksExpandIpCidrRange;
