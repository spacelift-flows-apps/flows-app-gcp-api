...
const subnetworksSetIamPolicy: AppBlock = {
  name: "Subnetworks - Set IAM Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/subnetworks/{resource}/setIamPolicy`;
...
export default subnetworksSetIamPolicy;
