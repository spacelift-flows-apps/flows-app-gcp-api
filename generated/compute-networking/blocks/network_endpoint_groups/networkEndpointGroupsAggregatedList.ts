...
const networkEndpointGroupsAggregatedList: AppBlock = {
  name: "Network Endpoint Groups - Aggregated List",
      ...
      type: {
        ...
        properties: {
          ...
          kind: {
            type: "string",
            description:
              "Output only. [Output Only] The resource type, which is alwayscompute#networkEndpointGroupAggregatedList for aggregated lists of network endpoint groups.",
          },
          nextPageToken: {
            type: "string",
            description:
...
export default networkEndpointGroupsAggregatedList;
