...
const globalPublicDelegatedPrefixesInsert: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/publicDelegatedPrefixes`;
...
export default globalPublicDelegatedPrefixesInsert;
