...
const globalNetworkEndpointGroupsAttachNetworkEndpoints: AppBlock = {
  name: "Global Network Endpoint Groups - Attach Network Endpoints",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/global/networkEndpointGroups/{network_endpoint_group}/attachNetworkEndpoints",
          pathParams,
          queryParams,
...
export default globalNetworkEndpointGroupsAttachNetworkEndpoints;
