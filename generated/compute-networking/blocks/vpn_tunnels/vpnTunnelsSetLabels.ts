...
const vpnTunnelsSetLabels: AppBlock = {
  name: "VPN Tunnels - Set Labels",
  description: `Sets the labels on a VpnTunnel.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/vpnTunnels/{resource}/setLabels`;
...
export default vpnTunnelsSetLabels;
