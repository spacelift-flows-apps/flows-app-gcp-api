...
const addressesSetLabels: AppBlock = {
  name: "Addresses - Set Labels",
  description: `Sets the labels on an Address.`,
  category: "Addresses",
  inputs: {
    default: {
      config: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/addresses/{resource}/setLabels`;
...
export default addressesSetLabels;
