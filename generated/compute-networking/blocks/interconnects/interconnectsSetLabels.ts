...
const interconnectsSetLabels: AppBlock = {
  name: "Interconnects - Set Labels",
  description: `Sets the labels on an Interconnect.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/interconnects/{resource}/setLabels`;
...
export default interconnectsSetLabels;
