...
const vpnGatewaysSetLabels: AppBlock = {
  name: "VPN Gateways - Set Labels",
  description: `Sets the labels on a VpnGateway.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/vpnGateways/{resource}/setLabels`;
...
export default vpnGatewaysSetLabels;
