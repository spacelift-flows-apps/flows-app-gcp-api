...
const vpnGatewaysAggregatedList: AppBlock = {
  name: "Vpn Gateways - Aggregated List",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "GET",
          pathTemplate: "/compute/v1/projects/{project}/aggregated/vpnGateways",
          pathParams,
          queryParams,
        });
...
export default vpnGatewaysAggregatedList;
