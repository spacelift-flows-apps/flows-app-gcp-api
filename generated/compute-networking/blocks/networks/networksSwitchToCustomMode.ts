...
const networksSwitchToCustomMode: AppBlock = {
  name: "Networks - Switch To Custom Mode",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/networks/{network}/switchToCustomMode`;
...
export default networksSwitchToCustomMode;
