...
const networksUpdatePeering: AppBlock = {
  name: "Networks - Update Peering",
  description: `Updates the specified network peering with the data included in the request.`,
  category: "Networks",
  inputs: {
    default: {
      config: {
        ...
        networkPeering: {
          ...
          description: "Request body field: networkPeering",
          type: {
            type: "object",
            properties: {
              updateStrategy: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/networks/{network}/updatePeering`;
        ...
        if (input.event.inputConfig.networkPeering !== undefined)
          requestBody.networkPeering = input.event.inputConfig.networkPeering;
...
export default networksUpdatePeering;
