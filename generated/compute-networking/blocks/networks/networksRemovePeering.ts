...
const networksRemovePeering: AppBlock = {
  name: "Networks - Remove Peering",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/networks/{network}/removePeering`;
...
export default networksRemovePeering;
