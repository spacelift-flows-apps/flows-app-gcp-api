  ...
  inputs: {
    default: {
      config: {
        ...
        peerNetwork: {
          name: "Peer Network",
          description: "URL of the peer network.",
          type: {
            type: "string",
            description:
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/networks/{network}/addPeering`;
        ...
        if (input.event.inputConfig.peerNetwork !== undefined)
          requestBody.peerNetwork = input.event.inputConfig.peerNetwork;
