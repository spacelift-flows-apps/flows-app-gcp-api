...
const networksAddPeering: AppBlock = {
  name: "Networks - Add Peering",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.autoCreateRoutes !== undefined)
          body.autoCreateRoutes = input.event.inputConfig.autoCreateRoutes;
        if (input.event.inputConfig.name !== undefined)
          body.name = input.event.inputConfig.name;
        if (input.event.inputConfig.networkPeering !== undefined)
          body.networkPeering = input.event.inputConfig.networkPeering;
        if (input.event.inputConfig.peerNetwork !== undefined)
          body.peerNetwork = input.event.inputConfig.peerNetwork;
...
export default networksAddPeering;
