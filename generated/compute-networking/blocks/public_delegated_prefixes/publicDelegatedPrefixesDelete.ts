...
const publicDelegatedPrefixesDelete: AppBlock = {
  name: "Public Delegated Prefixes - Delete",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/publicDelegatedPrefixes/{publicDelegatedPrefix}`;
...
export default publicDelegatedPrefixesDelete;
