...
const publicDelegatedPrefixesAnnounce: AppBlock = {
  name: "Public Delegated Prefixes - Announce",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/regions/{region}/publicDelegatedPrefixes/{public_delegated_prefix}/announce",
          pathParams,
          queryParams,
        });
...
export default publicDelegatedPrefixesAnnounce;
