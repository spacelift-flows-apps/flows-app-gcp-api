...
const publicDelegatedPrefixesWithdraw: AppBlock = {
  name: "Public Delegated Prefixes - Withdraw",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/regions/{region}/publicDelegatedPrefixes/{public_delegated_prefix}/withdraw",
          pathParams,
          queryParams,
        });
...
export default publicDelegatedPrefixesWithdraw;
