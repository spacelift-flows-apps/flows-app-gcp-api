...
const packetMirroringsInsert: AppBlock = {
  name: "Packet Mirrorings - Insert",
    ...
    default: {
        ...
        filter: {
          ...
          type: {
            ...
            properties: {
              ...
              direction: {
                type: "string",
                enum: ["UNDEFINED_DIRECTION", "BOTH", "EGRESS", "INGRESS"],
                description:
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.collectorIlb !== undefined)
          body.collectorIlb = input.event.inputConfig.collectorIlb;
        ...
        if (input.event.inputConfig.enable !== undefined)
          body.enable = input.event.inputConfig.enable;
        if (input.event.inputConfig.filter !== undefined)
          body.filter = input.event.inputConfig.filter;
        ...
        if (input.event.inputConfig.mirroredResources !== undefined)
          body.mirroredResources = input.event.inputConfig.mirroredResources;
...
export default packetMirroringsInsert;
