...
const routersUpdateRoutePolicy: AppBlock = {
  name: "Routers - Update Route Policy",
  ...
  inputs: {
    default: {
      config: {
        ...
        type: {
          name: "Type",
          description: "Check the Type enum for the list of possible values.",
          type: {
            type: "string",
            enum: [
              "UNDEFINED_TYPE",
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.terms !== undefined)
          body.terms = input.event.inputConfig.terms;
...
export default routersUpdateRoutePolicy;
