...
const externalVpnGatewaysInsert: AppBlock = {
  name: "External VPN Gateways - Insert",
  ...
  inputs: {
    default: {
      config: {
        ...
        interfaces: {
          name: "Interfaces",
          description: "A list of interfaces for this external VPN gateway.",
          type: {
            type: "array",
            items: {
              type: "object",
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.redundancyType !== undefined)
          requestBody.redundancyType = input.event.inputConfig.redundancyType;
...
export default externalVpnGatewaysInsert;
