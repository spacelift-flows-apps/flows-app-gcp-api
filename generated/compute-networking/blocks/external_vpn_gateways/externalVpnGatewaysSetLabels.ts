...
const externalVpnGatewaysSetLabels: AppBlock = {
  name: "External VPN Gateways - Set Labels",
  description: `Sets the labels on an ExternalVpnGateway.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/externalVpnGateways/{resource}/setLabels`;
...
export default externalVpnGatewaysSetLabels;
