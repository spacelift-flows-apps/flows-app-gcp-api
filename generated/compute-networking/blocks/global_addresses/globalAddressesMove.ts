...
const globalAddressesMove: AppBlock = {
  name: "Global Addresses - Move",
    ...
    default: {
      config: {
        ...
        destinationAddress: {
          ...
          description: "The URL of the destination address to move to.",
          type: {
            type: "string",
            description:
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/addresses/{address}/move`;
        ...
        if (input.event.inputConfig.destinationAddress !== undefined)
          requestBody.destinationAddress =
            input.event.inputConfig.destinationAddress;
...
export default globalAddressesMove;
