...
const globalAddressesSetLabels: AppBlock = {
  name: "Global Addresses - Set Labels",
  description: `Sets the labels on a GlobalAddress.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/addresses/{resource}/setLabels`;
...
export default globalAddressesSetLabels;
