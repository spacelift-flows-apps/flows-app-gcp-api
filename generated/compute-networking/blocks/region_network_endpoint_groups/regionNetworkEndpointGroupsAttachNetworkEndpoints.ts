...
const regionNetworkEndpointGroupsAttachNetworkEndpoints: AppBlock = {
  name: "Region Network Endpoint Groups - Attach Network Endpoints",
  description: `Attach a list of network endpoints to the specified network endpoint group.`,
  category: "Region Network Endpoint Groups",
  inputs: {
    default: {
      config: {
        region: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.networkEndpoints !== undefined)
          body.networkEndpoints = input.event.inputConfig.networkEndpoints;

        const result = await computeFetch({
          config: input.app.config,
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/regions/{region}/networkEndpointGroups/{network_endpoint_group}/attachNetworkEndpoints",
          pathParams,
          queryParams,
...
export default regionNetworkEndpointGroupsAttachNetworkEndpoints;
