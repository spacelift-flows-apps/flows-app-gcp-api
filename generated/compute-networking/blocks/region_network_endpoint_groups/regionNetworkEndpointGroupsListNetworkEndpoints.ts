...
const regionNetworkEndpointGroupsListNetworkEndpoints: AppBlock = {
  name: "Region Network Endpoint Groups - List Network Endpoints",
    ...
    default: {
      config: {
        region: {
          name: "Region",
          description:
            "The name of theregion where the network endpoint group is located. It should comply with RFC1035.",
          type: {
            type: "string",
            description:
              "The name of theregion where the network endpoint group is located. It should comply with RFC1035.",
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/regions/{region}/networkEndpointGroups/{network_endpoint_group}/listNetworkEndpoints",
          pathParams,
          queryParams,
        });
...
export default regionNetworkEndpointGroupsListNetworkEndpoints;
