...
const regionNetworkEndpointGroupsDetachNetworkEndpoints: AppBlock = {
  name: "Region Network Endpoint Groups - Detach Network Endpoints",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/regions/{region}/networkEndpointGroups/{network_endpoint_group}/detachNetworkEndpoints",
          pathParams,
          queryParams,
...
export default regionNetworkEndpointGroupsDetachNetworkEndpoints;
