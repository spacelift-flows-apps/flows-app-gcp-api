...
const regionNetworkEndpointGroupsDelete: AppBlock = {
  name: "Region Network Endpoint Groups - Delete",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "DELETE",
          pathTemplate:
            "/compute/v1/projects/{project}/regions/{region}/networkEndpointGroups/{network_endpoint_group}",
          pathParams,
          queryParams,
        });
...
export default regionNetworkEndpointGroupsDelete;
