...
const instancesSetDiskAutoDelete: AppBlock = {
  name: "Instances - Set Disk Auto Delete",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.autoDelete !== undefined)
          queryParams["autoDelete"] = String(
            input.event.inputConfig.autoDelete,
          );
        if (input.event.inputConfig.deviceName !== undefined)
          queryParams["deviceName"] = String(
            input.event.inputConfig.deviceName,
          );
...
export default instancesSetDiskAutoDelete;
