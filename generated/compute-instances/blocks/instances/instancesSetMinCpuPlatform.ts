...
const instancesSetMinCpuPlatform: AppBlock = {
  name: "Instances - Set Min Cpu Platform",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instances/{instance}/setMinCpuPlatform`;
...
export default instancesSetMinCpuPlatform;
