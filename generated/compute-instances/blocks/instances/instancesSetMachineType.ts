...
const instancesSetMachineType: AppBlock = {
  name: "Instances - Set Machine Type",
  ...
  inputs: {
    default: {
      config: {
        ...
        machineType: {
          name: "Machine Type",
          description: "Full or partial URL of the machine type resource.",
          type: {
            type: "string",
            description:
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instances/{instance}/setMachineType`;
...
export default instancesSetMachineType;
