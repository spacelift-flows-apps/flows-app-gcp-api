...
const instancesSetShieldedInstanceIntegrityPolicy: AppBlock = {
  name: "Instances - Set Shielded Instance Integrity Policy",
  description: `Sets the Shielded Instance integrity policy for an instance.`,
  category: "Instances",
  inputs: {
    default: {
      config: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instances/{instance}/setShieldedInstanceIntegrityPolicy`;
        ...
        if (input.event.inputConfig.updateAutoLearnPolicy !== undefined)
          requestBody.updateAutoLearnPolicy =
            input.event.inputConfig.updateAutoLearnPolicy;
...
export default instancesSetShieldedInstanceIntegrityPolicy;
