...
const instancesSetName: AppBlock = {
  name: "Instances - Set Name",
  ...
  inputs: {
    default: {
      config: {
        ...
        name: {
          name: "Name",
          description: "The name to be applied to the instance.",
          type: {
            type: "string",
            description:
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instances/{instance}/setName`;
        ...
        if (input.event.inputConfig.currentName !== undefined)
          requestBody.currentName = input.event.inputConfig.currentName;
...
export default instancesSetName;
