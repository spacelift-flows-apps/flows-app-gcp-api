...
const instancesPerformMaintenance: AppBlock = {
  name: "Instances - Perform Maintenance",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instances/{instance}/performMaintenance`;
...
export default instancesPerformMaintenance;
