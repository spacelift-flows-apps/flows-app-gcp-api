...
const instancesUpdateDisplayDevice: AppBlock = {
  name: "Instances - Update Display Device",
  description: `Updates the Display config for a VM instance.`,
  category: "Instances",
  inputs: {
    default: {
      config: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instances/{instance}/updateDisplayDevice`;
        ...
        if (input.event.inputConfig.enableDisplay !== undefined)
          requestBody.enableDisplay = input.event.inputConfig.enableDisplay;
...
export default instancesUpdateDisplayDevice;
