...
const instancesSetDeletionProtection: AppBlock = {
  name: "Instances - Set Deletion Protection",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instances/{resource}/setDeletionProtection`;
...
export default instancesSetDeletionProtection;
