...
const instancesReset: AppBlock = {
  name: "Instances - Reset",
  description: `Performs a reset on the instance.`,
  category: "Instances",
  inputs: {
    default: {
      config: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instances/{instance}/reset`;
