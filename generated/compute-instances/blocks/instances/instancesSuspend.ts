...
const instancesSuspend: AppBlock = {
  name: "Instances - Suspend",
  description: `This method suspends a running instance, saving its state to persistent storage, and allows you to resume the instance at a later time.`,
  category: "Instances",
  inputs: {
    default: {
      config: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instances/{instance}/suspend`;
...
export default instancesSuspend;
