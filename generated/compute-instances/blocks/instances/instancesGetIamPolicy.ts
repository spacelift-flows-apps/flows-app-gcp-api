...
const instancesGetIamPolicy: AppBlock = {
  name: "Instances - Get IAM Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instances/{resource}/getIamPolicy`;
...
export default instancesGetIamPolicy;
