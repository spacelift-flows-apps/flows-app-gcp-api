...
const instancesStart: AppBlock = {
  name: "Instances - Start",
  description: `Starts an instance that was stopped using theinstances().`,
  category: "Instances",
  inputs: {
    default: {
      config: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instances/{instance}/start`;
