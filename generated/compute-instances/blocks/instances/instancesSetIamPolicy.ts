...
const instancesSetIamPolicy: AppBlock = {
  name: "Instances - Set IAM Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instances/{resource}/setIamPolicy`;
...
export default instancesSetIamPolicy;
