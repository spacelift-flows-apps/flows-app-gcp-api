...
const instancesReportHostAsFaulty: AppBlock = {
  name: "Instances - Report Host As Faulty",
  ...
  inputs: {
    default: {
      config: {
        ...
        faultReasons: {
          name: "Fault Reasons",
          description: "Fault Reasons field",
          type: {
            type: "array",
            items: {
              type: "object",
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.disruptionSchedule !== undefined)
          body.disruptionSchedule = input.event.inputConfig.disruptionSchedule;
        if (input.event.inputConfig.faultReasons !== undefined)
          body.faultReasons = input.event.inputConfig.faultReasons;
...
export default instancesReportHostAsFaulty;
