...
const instancesSetMachineResources: AppBlock = {
  name: "Instances - Set Machine Resources",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instances/{instance}/setMachineResources`;
...
export default instancesSetMachineResources;
