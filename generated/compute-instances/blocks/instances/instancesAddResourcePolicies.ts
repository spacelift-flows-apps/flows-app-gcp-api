...
const instancesAddResourcePolicies: AppBlock = {
  name: "Instances - Add Resource Policies",
  description: `Adds existing resource policies to an instance.`,
  category: "Instances",
  inputs: {
    default: {
      config: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instances/{instance}/addResourcePolicies`;
...
export default instancesAddResourcePolicies;
