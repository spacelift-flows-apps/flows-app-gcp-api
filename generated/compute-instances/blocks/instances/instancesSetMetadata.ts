...
const instancesSetMetadata: AppBlock = {
  name: "Instances - Set Metadata",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instances/{instance}/setMetadata`;
        ...
        if (input.event.inputConfig.items !== undefined)
          requestBody.items = input.event.inputConfig.items;
...
export default instancesSetMetadata;
