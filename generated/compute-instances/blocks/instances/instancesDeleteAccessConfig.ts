...
const instancesDeleteAccessConfig: AppBlock = {
  name: "Instances - Delete Access Config",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.accessConfig !== undefined)
          queryParams["accessConfig"] = String(
            input.event.inputConfig.accessConfig,
          );
...
export default instancesDeleteAccessConfig;
