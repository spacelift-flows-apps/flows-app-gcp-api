...
const instancesSetServiceAccount: AppBlock = {
  name: "Instances - Set Service Account",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instances/{instance}/setServiceAccount`;
        ...
        if (input.event.inputConfig.scopes !== undefined)
          requestBody.scopes = input.event.inputConfig.scopes;
...
export default instancesSetServiceAccount;
