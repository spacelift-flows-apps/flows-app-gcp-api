...
const instancesAggregatedList: AppBlock = {
  name: "Instances - Aggregated List",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "GET",
          pathTemplate: "/compute/v1/projects/{project}/aggregated/instances",
          pathParams,
          queryParams,
        });
...
export default instancesAggregatedList;
