...
const instancesDeleteNetworkInterface: AppBlock = {
  name: "Instances - Delete Network Interface",
  description: `Deletes one dynamic network interface from an active instance.`,
  category: "Instances",
  inputs: {
    default: {
      config: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instances/{instance}/deleteNetworkInterface`;
...
export default instancesDeleteNetworkInterface;
