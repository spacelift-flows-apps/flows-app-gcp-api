...
const instancesUpdateShieldedInstanceConfig: AppBlock = {
  name: "Instances - Update Shielded Instance Config",
  description: `Updates the Shielded Instance config for an instance.`,
  category: "Instances",
  inputs: {
    default: {
      config: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instances/{instance}/updateShieldedInstanceConfig`;
        ...
        if (input.event.inputConfig.enableSecureBoot !== undefined)
          requestBody.enableSecureBoot =
            input.event.inputConfig.enableSecureBoot;
        if (input.event.inputConfig.enableIntegrityMonitoring !== undefined)
          requestBody.enableIntegrityMonitoring =
            input.event.inputConfig.enableIntegrityMonitoring;
        if (input.event.inputConfig.enableVtpm !== undefined)
          requestBody.enableVtpm = input.event.inputConfig.enableVtpm;
...
export default instancesUpdateShieldedInstanceConfig;
