...
const instancesSetSecurityPolicy: AppBlock = {
  name: "Instances - Set Security Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instances/{instance}/setSecurityPolicy`;
...
export default instancesSetSecurityPolicy;
