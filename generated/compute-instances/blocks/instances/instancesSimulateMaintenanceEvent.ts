...
const instancesSimulateMaintenanceEvent: AppBlock = {
  name: "Instances - Simulate Maintenance Event",
    ...
    default: {
      config: {
        ...
        withExtendedNotifications: {
          name: "With Extended Notifications",
          description:
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.withExtendedNotifications !== undefined)
          queryParams["withExtendedNotifications"] = String(
            input.event.inputConfig.withExtendedNotifications,
          );
...
export default instancesSimulateMaintenanceEvent;
