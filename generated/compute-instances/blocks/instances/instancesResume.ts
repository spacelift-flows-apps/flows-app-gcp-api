...
const instancesResume: AppBlock = {
  name: "Instances - Resume",
  description: `Resumes an instance that was suspended using theinstances().`,
  category: "Instances",
  inputs: {
    default: {
      config: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instances/{instance}/resume`;
...
export default instancesResume;
