...
const instancesSetLabels: AppBlock = {
  name: "Instances - Set Labels",
  description: `Sets labels on an instance.`,
  category: "Instances",
  inputs: {
    default: {
      config: {
        ...
        labels: {
          name: "Labels",
          description: "Request body field: labels",
          type: {
            type: "object",
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instances/{instance}/setLabels`;
...
export default instancesSetLabels;
