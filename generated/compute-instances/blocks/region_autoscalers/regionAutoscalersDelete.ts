...
const regionAutoscalersDelete: AppBlock = {
  name: "Region Autoscalers - Delete",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.autoscaler !== undefined)
          pathParams["autoscaler"] = String(input.event.inputConfig.autoscaler);
...
export default regionAutoscalersDelete;
