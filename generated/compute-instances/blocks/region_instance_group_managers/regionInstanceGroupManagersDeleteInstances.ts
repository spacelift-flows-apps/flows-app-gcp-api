...
const regionInstanceGroupManagersDeleteInstances: AppBlock = {
  name: "Region Instance Group Managers - Delete Instances",
  description: `Flags the specified instances in the managed instance group to be immediately deleted.`,
  ...
  inputs: {
    default: {
      config: {
        ...
        instances: {
          name: "Instances",
          description: "The URLs of one or more instances to delete.",
          type: {
            type: "array",
            items: {
              type: "string",
        ...
        skipInstancesOnValidationError: {
          name: "Skip Instances On Validation Error",
          description:
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/instanceGroupManagers/{instanceGroupManager}/deleteInstances`;
        ...
        if (
          input.event.inputConfig.skipInstancesOnValidationError !== undefined
        )
          requestBody.skipInstancesOnValidationError =
            input.event.inputConfig.skipInstancesOnValidationError;
...
export default regionInstanceGroupManagersDeleteInstances;
