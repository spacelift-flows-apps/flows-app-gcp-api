...
const regionInstanceGroupManagersPatchPerInstanceConfigs: AppBlock = {
  name: "Region Instance Group Managers - Patch Per Instance Configs",
  description: `Inserts or patches per-instance configurations for the managed instance group.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/instanceGroupManagers/{instanceGroupManager}/patchPerInstanceConfigs`;
...
export default regionInstanceGroupManagersPatchPerInstanceConfigs;
