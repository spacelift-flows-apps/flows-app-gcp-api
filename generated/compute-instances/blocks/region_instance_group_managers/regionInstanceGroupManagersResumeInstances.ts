...
const regionInstanceGroupManagersResumeInstances: AppBlock = {
  name: "Region Instance Group Managers - Resume Instances",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/resumeInstances",
          pathParams,
          queryParams,
...
export default regionInstanceGroupManagersResumeInstances;
