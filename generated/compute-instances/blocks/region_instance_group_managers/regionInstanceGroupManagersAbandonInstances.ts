...
const regionInstanceGroupManagersAbandonInstances: AppBlock = {
  name: "Region Instance Group Managers - Abandon Instances",
  description: `Flags the specified instances to be immediately removed from the managed instance group.`,
  ...
  inputs: {
    default: {
      config: {
        ...
        instances: {
          name: "Instances",
          description: "The URLs of one or more instances to abandon.",
          type: {
            type: "array",
            items: {
              type: "string",
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/instanceGroupManagers/{instanceGroupManager}/abandonInstances`;
...
export default regionInstanceGroupManagersAbandonInstances;
