...
const regionInstanceGroupManagersCreateInstances: AppBlock = {
  name: "Region Instance Group Managers - Create Instances",
  description: `Creates instances with per-instance configurations in this regional managed instance group.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/instanceGroupManagers/{instanceGroupManager}/createInstances`;
...
export default regionInstanceGroupManagersCreateInstances;
