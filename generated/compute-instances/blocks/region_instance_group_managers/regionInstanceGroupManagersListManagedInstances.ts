...
const regionInstanceGroupManagersListManagedInstances: AppBlock = {
  name: "Region Instance Group Managers - List Managed Instances",
  description: `Lists the instances in the managed instance group and instances that are scheduled to be created.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/instanceGroupManagers/{instanceGroupManager}/listManagedInstances`;
...
export default regionInstanceGroupManagersListManagedInstances;
