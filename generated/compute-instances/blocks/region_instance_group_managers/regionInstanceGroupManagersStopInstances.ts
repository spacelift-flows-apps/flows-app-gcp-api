...
const regionInstanceGroupManagersStopInstances: AppBlock = {
  name: "Region Instance Group Managers - Stop Instances",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.forceStop !== undefined)
          body.forceStop = input.event.inputConfig.forceStop;
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/stopInstances",
          pathParams,
          queryParams,
...
export default regionInstanceGroupManagersStopInstances;
