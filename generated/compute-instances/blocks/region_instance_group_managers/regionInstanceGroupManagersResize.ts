...
const regionInstanceGroupManagersResize: AppBlock = {
  name: "Region Instance Group Managers - Resize",
  description: `Changes the intended size of the managed instance group.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/instanceGroupManagers/{instanceGroupManager}/resize`;
...
export default regionInstanceGroupManagersResize;
