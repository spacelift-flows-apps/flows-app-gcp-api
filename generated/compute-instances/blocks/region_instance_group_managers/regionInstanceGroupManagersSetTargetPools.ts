...
const regionInstanceGroupManagersSetTargetPools: AppBlock = {
  name: "Region Instance Group Managers - Set Target Pools",
  description: `Modifies the target pools to which all new instances in this group are assigned.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/instanceGroupManagers/{instanceGroupManager}/setTargetPools`;
...
export default regionInstanceGroupManagersSetTargetPools;
