...
const regionInstanceGroupManagersApplyUpdatesToInstances: AppBlock = {
  name: "Region Instance Group Managers - Apply Updates To Instances",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/instanceGroupManagers/{instanceGroupManager}/applyUpdatesToInstances`;
...
export default regionInstanceGroupManagersApplyUpdatesToInstances;
