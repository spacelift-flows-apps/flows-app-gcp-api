...
const regionInstanceGroupManagersRecreateInstances: AppBlock = {
  name: "Region Instance Group Managers - Recreate Instances",
  description: `Flags the specified VM instances in the managed instance group to be immediately recreated.`,
  ...
  inputs: {
    default: {
      config: {
        ...
        instances: {
          name: "Instances",
          description: "The URLs of one or more instances to recreate.",
          type: {
            type: "array",
            items: {
              type: "string",
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/instanceGroupManagers/{instanceGroupManager}/recreateInstances`;
...
export default regionInstanceGroupManagersRecreateInstances;
