...
const regionInstanceGroupManagersListPerInstanceConfigs: AppBlock = {
  name: "Region Instance Group Managers - List Per Instance Configs",
  description: `Lists all of the per-instance configurations defined for the managed instance group.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/instanceGroupManagers/{instanceGroupManager}/listPerInstanceConfigs`;
...
export default regionInstanceGroupManagersListPerInstanceConfigs;
