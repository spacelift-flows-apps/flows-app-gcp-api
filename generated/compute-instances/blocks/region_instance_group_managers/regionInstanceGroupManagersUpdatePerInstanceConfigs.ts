...
const regionInstanceGroupManagersUpdatePerInstanceConfigs: AppBlock = {
  name: "Region Instance Group Managers - Update Per Instance Configs",
  description: `Inserts or updates per-instance configurations for the managed instance group.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/instanceGroupManagers/{instanceGroupManager}/updatePerInstanceConfigs`;
        ...
        if (input.event.inputConfig.perInstanceConfigs !== undefined)
          requestBody.perInstanceConfigs =
            input.event.inputConfig.perInstanceConfigs;
...
export default regionInstanceGroupManagersUpdatePerInstanceConfigs;
