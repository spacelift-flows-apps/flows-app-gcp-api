    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.perInstanceConfigs !== undefined)
          body.perInstanceConfigs = input.event.inputConfig.perInstanceConfigs;

        const result = await computeFetch({
          config: input.app.config,
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/updatePerInstanceConfigs",
          pathParams,
          queryParams,
