...
const regionInstanceGroupManagersSetInstanceTemplate: AppBlock = {
  name: "Region Instance Group Managers - Set Instance Template",
  description: `Sets the instance template to use when creating new instances or recreating instances in this group.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/instanceGroupManagers/{instanceGroupManager}/setInstanceTemplate`;
...
export default regionInstanceGroupManagersSetInstanceTemplate;
