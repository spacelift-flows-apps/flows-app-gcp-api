...
const regionInstanceGroupManagersSuspendInstances: AppBlock = {
  name: "Region Instance Group Managers - Suspend Instances",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.forceSuspend !== undefined)
          body.forceSuspend = input.event.inputConfig.forceSuspend;
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/suspendInstances",
          pathParams,
          queryParams,
...
export default regionInstanceGroupManagersSuspendInstances;
