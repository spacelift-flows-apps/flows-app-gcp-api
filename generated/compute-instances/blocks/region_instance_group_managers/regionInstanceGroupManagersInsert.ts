...
const regionInstanceGroupManagersInsert: AppBlock = {
  name: "Region Instance Group Managers - Insert",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/instanceGroupManagers`;
...
export default regionInstanceGroupManagersInsert;
