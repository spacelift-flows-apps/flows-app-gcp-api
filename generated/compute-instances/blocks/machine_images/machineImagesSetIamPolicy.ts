...
const machineImagesSetIamPolicy: AppBlock = {
  name: "Machine Images - Set IAM Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/machineImages/{resource}/setIamPolicy`;
...
export default machineImagesSetIamPolicy;
