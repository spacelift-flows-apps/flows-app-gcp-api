...
const machineImagesGetIamPolicy: AppBlock = {
  name: "Machine Images - Get IAM Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/machineImages/{resource}/getIamPolicy`;
...
export default machineImagesGetIamPolicy;
