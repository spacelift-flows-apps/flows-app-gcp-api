...
const instanceTemplatesGetIamPolicy: AppBlock = {
  name: "Instance Templates - Get IAM Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/instanceTemplates/{resource}/getIamPolicy`;
...
export default instanceTemplatesGetIamPolicy;
