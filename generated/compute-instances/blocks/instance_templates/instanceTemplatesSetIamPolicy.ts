...
const instanceTemplatesSetIamPolicy: AppBlock = {
  name: "Instance Templates - Set IAM Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/instanceTemplates/{resource}/setIamPolicy`;
...
export default instanceTemplatesSetIamPolicy;
