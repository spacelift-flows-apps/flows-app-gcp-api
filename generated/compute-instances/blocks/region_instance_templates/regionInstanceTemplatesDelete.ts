...
const regionInstanceTemplatesDelete: AppBlock = {
  name: "Region Instance Templates - Delete",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.instanceTemplate !== undefined)
          pathParams["instance_template"] = String(
        ...
        const result = await computeFetch({
          ...
          method: "DELETE",
          pathTemplate:
            "/compute/v1/projects/{project}/regions/{region}/instanceTemplates/{instance_template}",
          pathParams,
          queryParams,
        });
...
export default regionInstanceTemplatesDelete;
