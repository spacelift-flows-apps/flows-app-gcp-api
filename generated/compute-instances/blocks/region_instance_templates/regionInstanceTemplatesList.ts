...
const regionInstanceTemplatesList: AppBlock = {
  name: "Region Instance Templates - List",
      ...
      type: {
        ...
        properties: {
          ...
          kind: {
            type: "string",
            description:
              "Output only. [Output Only] The resource type, which is alwayscompute#instanceTemplatesListResponse for instance template lists.",
          },
          nextPageToken: {
            type: "string",
            description:
...
export default regionInstanceTemplatesList;
