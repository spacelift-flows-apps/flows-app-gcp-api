...
const machineTypesAggregatedList: AppBlock = {
  name: "Machine Types - Aggregated List",
      ...
      type: {
        ...
        properties: {
          ...
          kind: {
            type: "string",
            description:
              "Output only. [Output Only] Type of resource. Alwayscompute#machineTypeAggregatedList for aggregated lists of machine types.",
          },
          nextPageToken: {
            type: "string",
            description:
...
export default machineTypesAggregatedList;
