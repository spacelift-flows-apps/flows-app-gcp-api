...
const autoscalersList: AppBlock = {
  name: "Autoscalers - List",
      ...
      type: {
        ...
        properties: {
          ...
          kind: {
            type: "string",
            description:
              "Output only. [Output Only] Type of resource. Always compute#autoscalerList for lists of autoscalers.",
          },
          nextPageToken: {
            type: "string",
            description:
...
export default autoscalersList;
