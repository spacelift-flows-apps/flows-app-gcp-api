...
const regionInstanceGroupsListInstances: AppBlock = {
  name: "Region Instance Groups - List Instances",
  ...
  inputs: {
    default: {
      config: {
        ...
        portName: {
          name: "Port Name",
          description: "Name of port user is interested in.",
          type: {
            type: "string",
            description:
        ...
        instanceState: {
          name: "Instance State",
          description: "Instances in which state should be returned.",
          type: {
            type: "string",
            enum: ["ALL", "RUNNING"],
            description:
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/instanceGroups/{instanceGroup}/listInstances`;
        ...
        if (input.event.inputConfig.instanceState !== undefined)
          requestBody.instanceState = input.event.inputConfig.instanceState;
...
export default regionInstanceGroupsListInstances;
