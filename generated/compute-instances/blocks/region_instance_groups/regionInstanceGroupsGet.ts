...
const regionInstanceGroupsGet: AppBlock = {
  name: "Region Instance Groups - Get",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/instanceGroups/{instanceGroup}`;
...
export default regionInstanceGroupsGet;
