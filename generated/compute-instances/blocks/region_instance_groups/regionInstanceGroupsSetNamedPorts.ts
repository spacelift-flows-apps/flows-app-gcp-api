...
const regionInstanceGroupsSetNamedPorts: AppBlock = {
  name: "Region Instance Groups - Set Named Ports",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/instanceGroups/{instanceGroup}/setNamedPorts`;
...
export default regionInstanceGroupsSetNamedPorts;
