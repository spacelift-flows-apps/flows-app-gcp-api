...
const zoneOperationsWait: AppBlock = {
  name: "Zone Operations - Wait",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/operations/{operation}/wait`;
...
export default zoneOperationsWait;
