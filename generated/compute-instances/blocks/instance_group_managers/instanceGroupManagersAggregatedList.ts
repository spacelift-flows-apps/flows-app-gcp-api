...
const instanceGroupManagersAggregatedList: AppBlock = {
  name: "Instance Group Managers - Aggregated List",
      ...
      type: {
        ...
        properties: {
          ...
          kind: {
            type: "string",
            description:
              "Output only. [Output Only] The resource type, which is alwayscompute#instanceGroupManagerAggregatedList for an aggregated list of managed instance groups.",
          },
          nextPageToken: {
            type: "string",
            description:
...
export default instanceGroupManagersAggregatedList;
