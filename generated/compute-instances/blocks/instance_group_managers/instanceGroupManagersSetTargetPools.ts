...
const instanceGroupManagersSetTargetPools: AppBlock = {
  name: "Instance Group Managers - Set Target Pools",
  description: `Modifies the target pools to which all instances in this managed instance group are assigned.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instanceGroupManagers/{instanceGroupManager}/setTargetPools`;
...
export default instanceGroupManagersSetTargetPools;
