...
const instanceGroupManagersApplyUpdatesToInstances: AppBlock = {
  name: "Instance Group Managers - Apply Updates To Instances",
  description: `Applies changes to selected instances on the managed instance group.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instanceGroupManagers/{instanceGroupManager}/applyUpdatesToInstances`;
        ...
        if (input.event.inputConfig.allInstances !== undefined)
          requestBody.allInstances = input.event.inputConfig.allInstances;
        if (input.event.inputConfig.minimalAction !== undefined)
          requestBody.minimalAction = input.event.inputConfig.minimalAction;
        ...
        if (input.event.inputConfig.mostDisruptiveAllowedAction !== undefined)
          requestBody.mostDisruptiveAllowedAction =
...
export default instanceGroupManagersApplyUpdatesToInstances;
