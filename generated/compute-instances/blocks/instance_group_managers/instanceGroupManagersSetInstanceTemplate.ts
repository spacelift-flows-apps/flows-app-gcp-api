...
const instanceGroupManagersSetInstanceTemplate: AppBlock = {
  name: "Instance Group Managers - Set Instance Template",
  description: `Specifies the instance template to use when creating new instances in this group.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instanceGroupManagers/{instanceGroupManager}/setInstanceTemplate`;
...
export default instanceGroupManagersSetInstanceTemplate;
