...
const instanceGroupManagersResize: AppBlock = {
  name: "Instance Group Managers - Resize",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instanceGroupManagers/{instanceGroupManager}/resize`;
...
export default instanceGroupManagersResize;
