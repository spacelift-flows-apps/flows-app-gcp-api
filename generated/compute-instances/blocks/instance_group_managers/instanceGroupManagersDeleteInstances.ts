...
const instanceGroupManagersDeleteInstances: AppBlock = {
  name: "Instance Group Managers - Delete Instances",
  description: `Flags the specified instances in the managed instance group for immediate deletion.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instanceGroupManagers/{instanceGroupManager}/deleteInstances`;
...
export default instanceGroupManagersDeleteInstances;
