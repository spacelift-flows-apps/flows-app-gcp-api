...
const instanceGroupManagersAbandonInstances: AppBlock = {
  name: "Instance Group Managers - Abandon Instances",
  description: `Flags the specified instances to be removed from the managed instance group.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instanceGroupManagers/{instanceGroupManager}/abandonInstances`;
...
export default instanceGroupManagersAbandonInstances;
