...
const instanceGroupManagersDeletePerInstanceConfigs: AppBlock = {
  name: "Instance Group Managers - Delete Per Instance Configs",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instanceGroupManagers/{instanceGroupManager}/deletePerInstanceConfigs`;
        ...
        if (input.event.inputConfig.names !== undefined)
          requestBody.names = input.event.inputConfig.names;
...
export default instanceGroupManagersDeletePerInstanceConfigs;
