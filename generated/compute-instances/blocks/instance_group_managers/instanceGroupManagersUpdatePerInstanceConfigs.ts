...
const instanceGroupManagersUpdatePerInstanceConfigs: AppBlock = {
  name: "Instance Group Managers - Update Per Instance Configs",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instanceGroupManagers/{instanceGroupManager}/updatePerInstanceConfigs`;
...
export default instanceGroupManagersUpdatePerInstanceConfigs;
