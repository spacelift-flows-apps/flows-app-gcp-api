...
const instanceGroupManagersStopInstances: AppBlock = {
  name: "Instance Group Managers - Stop Instances",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/stopInstances",
          pathParams,
          queryParams,
...
export default instanceGroupManagersStopInstances;
