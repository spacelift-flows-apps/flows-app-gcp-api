...
const instanceGroupManagersRecreateInstances: AppBlock = {
  name: "Instance Group Managers - Recreate Instances",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instanceGroupManagers/{instanceGroupManager}/recreateInstances`;
...
export default instanceGroupManagersRecreateInstances;
