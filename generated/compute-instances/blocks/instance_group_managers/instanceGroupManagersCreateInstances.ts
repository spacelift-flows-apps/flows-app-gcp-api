...
const instanceGroupManagersCreateInstances: AppBlock = {
  name: "Instance Group Managers - Create Instances",
  description: `Creates instances with per-instance configurations in this managed instance group.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instanceGroupManagers/{instanceGroupManager}/createInstances`;
...
export default instanceGroupManagersCreateInstances;
