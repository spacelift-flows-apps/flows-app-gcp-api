...
const instanceGroupManagersListPerInstanceConfigs: AppBlock = {
  name: "Instance Group Managers - List Per Instance Configs",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instanceGroupManagers/{instanceGroupManager}/listPerInstanceConfigs`;
...
export default instanceGroupManagersListPerInstanceConfigs;
