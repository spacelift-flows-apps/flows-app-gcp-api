...
const instanceGroupsRemoveInstances: AppBlock = {
  name: "Instance Groups - Remove Instances",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instanceGroups/{instanceGroup}/removeInstances`;
...
export default instanceGroupsRemoveInstances;
