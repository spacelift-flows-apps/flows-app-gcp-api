...
const instanceGroupsSetNamedPorts: AppBlock = {
  name: "Instance Groups - Set Named Ports",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instanceGroups/{instanceGroup}/setNamedPorts`;
...
export default instanceGroupsSetNamedPorts;
