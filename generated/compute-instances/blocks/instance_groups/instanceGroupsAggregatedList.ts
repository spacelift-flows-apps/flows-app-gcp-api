...
const instanceGroupsAggregatedList: AppBlock = {
  name: "Instance Groups - Aggregated List",
      ...
      type: {
        ...
        properties: {
          ...
          kind: {
            type: "string",
            description:
              "Output only. [Output Only] The resource type, which is alwayscompute#instanceGroupAggregatedList for aggregated lists of instance groups.",
          },
          nextPageToken: {
            type: "string",
            description:
...
export default instanceGroupsAggregatedList;
