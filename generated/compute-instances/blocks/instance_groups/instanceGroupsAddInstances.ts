...
const instanceGroupsAddInstances: AppBlock = {
  name: "Instance Groups - Add Instances",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instanceGroups/{instanceGroup}/addInstances`;
...
export default instanceGroupsAddInstances;
