...
const instanceGroupsListInstances: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/zones/{zone}/instanceGroups/{instanceGroup}/listInstances`;
...
export default instanceGroupsListInstances;
