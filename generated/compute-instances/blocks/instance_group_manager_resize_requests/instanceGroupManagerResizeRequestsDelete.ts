...
const instanceGroupManagerResizeRequestsDelete: AppBlock = {
  name: "Instance Group Manager Resize Requests - Delete",
...
export default instanceGroupManagerResizeRequestsDelete;
