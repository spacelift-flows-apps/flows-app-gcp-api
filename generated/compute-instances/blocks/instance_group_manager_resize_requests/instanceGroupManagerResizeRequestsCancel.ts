...
const instanceGroupManagerResizeRequestsCancel: AppBlock = {
  name: "Instance Group Manager Resize Requests - Cancel",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/resizeRequests/{resize_request}/cancel",
          pathParams,
          queryParams,
        });
...
export default instanceGroupManagerResizeRequestsCancel;
