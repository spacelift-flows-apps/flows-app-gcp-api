...
const clustersMonitoring: AppBlock = {
  name: "Clusters - Monitoring",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/monitoring`;
        ...
        if (input.event.inputConfig.monitoringService !== undefined)
          requestBody.monitoringService =
            input.event.inputConfig.monitoringService;
...
export default clustersMonitoring;
