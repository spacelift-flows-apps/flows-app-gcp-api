...
const clustersCompleteIpRotation: AppBlock = {
  name: "Clusters - Complete IP Rotation",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}:completeIpRotation`;
...
export default clustersCompleteIpRotation;
