...
const clustersLegacyAbac: AppBlock = {
  name: "Clusters - Legacy ABAC",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/legacyAbac`;
...
export default clustersLegacyAbac;
