...
const clustersLogging: AppBlock = {
  name: "Clusters - Logging",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/logging`;
        ...
        if (input.event.inputConfig.loggingService !== undefined)
          requestBody.loggingService = input.event.inputConfig.loggingService;
...
export default clustersLogging;
