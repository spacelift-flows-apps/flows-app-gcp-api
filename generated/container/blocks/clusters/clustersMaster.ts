...
const clustersMaster: AppBlock = {
  name: "Clusters - Master",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/master`;
        ...
        if (input.event.inputConfig.masterVersion !== undefined)
          requestBody.masterVersion = input.event.inputConfig.masterVersion;
