    ...
    fields: {
      ...
      nodeConfig: {
        ...
        fields: {
          ...
          localNvmeSsdBlockConfig: {
            name: "local_nvme_ssd_block_config",
            fields: {
              localSsdCount: "local_ssd_count",
            },
          },
          ephemeralStorageLocalSsdConfig: {
            name: "ephemeral_storage_local_ssd_config",
            fields: {
              localSsdCount: "local_ssd_count",
      ...
      nodePools: {
        ...
        fields: {
          ...
          networkConfig: {
            ...
            fields: {
              ...
              additionalPodNetworkConfigs: {
                name: "additional_pod_network_configs",
                fields: {
          ...
          queuedProvisioning: "queued_provisioning",
          bestEffortProvisioning: {
            name: "best_effort_provisioning",
            fields: {
              minProvisionNodes: "min_provision_nodes",
            },
          },
          nodeDrainConfig: {
            name: "node_drain_config",
            fields: {
      ...
      ipAllocationPolicy: {
        ...
        fields: {
          ...
          podCidrOverprovisionConfig: "pod_cidr_overprovision_config",
          autoIpamConfig: "auto_ipam_config",
          networkTierConfig: {
      ...
      autopilot: {
        ...
        fields: {
          ...
          privilegedAdmissionConfig: {
            name: "privileged_admission_config",
            fields: {
      ...
      compliancePostureConfig: {
        name: "compliance_posture_config",
        fields: {
      ...
      anonymousAuthenticationConfig: "anonymous_authentication_config",
      managedOpentelemetryConfig: "managed_opentelemetry_config",
    },
  },
};
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await new Promise<any>((resolve, reject) => {
          client.createCluster(request, (err: any, response: any) => {
            if (err)
              reject(
                new Error(
