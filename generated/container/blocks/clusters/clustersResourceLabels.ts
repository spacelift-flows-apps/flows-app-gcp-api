...
const clustersResourceLabels: AppBlock = {
  name: "Clusters - Resource Labels",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/resourceLabels`;
...
export default clustersResourceLabels;
