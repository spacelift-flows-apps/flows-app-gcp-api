...
const clustersStartIpRotation: AppBlock = {
  name: "Clusters - Start IP Rotation",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}:startIpRotation`;
        ...
        if (input.event.inputConfig.rotateCredentials !== undefined)
          requestBody.rotateCredentials =
            input.event.inputConfig.rotateCredentials;
...
export default clustersStartIpRotation;
