...
const nodePoolsSetManagement: AppBlock = {
  name: "Node Pools - Set Management",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/nodePools/{nodePoolId}/setManagement`;
        ...
        if (input.event.inputConfig.management !== undefined)
          requestBody.management = input.event.inputConfig.management;
...
export default nodePoolsSetManagement;
