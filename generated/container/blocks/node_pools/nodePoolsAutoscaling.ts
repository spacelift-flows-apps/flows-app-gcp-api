...
const nodePoolsAutoscaling: AppBlock = {
  name: "Node Pools - Autoscaling",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/nodePools/{nodePoolId}/autoscaling`;
        ...
        if (input.event.inputConfig.autoscaling !== undefined)
          requestBody.autoscaling = input.event.inputConfig.autoscaling;
...
export default nodePoolsAutoscaling;
