...
const nodePoolsSetSize: AppBlock = {
  name: "Node Pools - Set Size",
  ...
  inputs: {
    default: {
      config: {
        nodeCount: {
          ...
          type: {
            type: "integer",
            description:
              "Required. The desired node count for the pool. (Format: int32)",
          },
          required: false,
        },
        name: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{projectId}/zones/{zone}/clusters/{clusterId}/nodePools/{nodePoolId}/setSize`;
...
export default nodePoolsSetSize;
