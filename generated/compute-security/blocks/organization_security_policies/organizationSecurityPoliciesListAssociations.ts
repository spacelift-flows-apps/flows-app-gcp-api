...
const organizationSecurityPoliciesListAssociations: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `locations/global/securityPolicies/listAssociations`;
...
export default organizationSecurityPoliciesListAssociations;
