  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `locations/global/securityPolicies/{securityPolicy}/addAssociation`;
        ...
        if (input.event.inputConfig.securityPolicyId !== undefined)
          requestBody.securityPolicyId =
            input.event.inputConfig.securityPolicyId;
        if (input.event.inputConfig.name !== undefined)
          requestBody.name = input.event.inputConfig.name;
        if (input.event.inputConfig.attachmentId !== undefined)
          requestBody.attachmentId = input.event.inputConfig.attachmentId;
        ...
        if (input.event.inputConfig.excludedProjects !== undefined)
          requestBody.excludedProjects =
            input.event.inputConfig.excludedProjects;
        if (input.event.inputConfig.excludedFolders !== undefined)
          requestBody.excludedFolders = input.event.inputConfig.excludedFolders;
