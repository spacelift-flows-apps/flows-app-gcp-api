...
const organizationSecurityPoliciesRemoveAssociation: AppBlock = {
  name: "Organization Security Policies - Remove Association",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate:
            "/compute/v1/locations/global/securityPolicies/{security_policy}/removeAssociation",
          pathParams,
          queryParams,
        });
...
export default organizationSecurityPoliciesRemoveAssociation;
