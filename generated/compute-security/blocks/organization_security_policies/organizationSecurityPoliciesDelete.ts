...
const organizationSecurityPoliciesDelete: AppBlock = {
  name: "Organization Security Policies - Delete",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `locations/global/securityPolicies/{securityPolicy}`;
...
export default organizationSecurityPoliciesDelete;
