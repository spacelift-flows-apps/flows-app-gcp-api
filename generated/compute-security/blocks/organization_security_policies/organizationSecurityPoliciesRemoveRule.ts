...
const organizationSecurityPoliciesRemoveRule: AppBlock = {
  name: "Organization Security Policies - Remove Rule",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `locations/global/securityPolicies/{securityPolicy}/removeRule`;
...
export default organizationSecurityPoliciesRemoveRule;
