...
const sslPoliciesAggregatedList: AppBlock = {
  name: "Ssl Policies - Aggregated List",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "GET",
          pathTemplate: "/compute/v1/projects/{project}/aggregated/sslPolicies",
          pathParams,
          queryParams,
        });
...
export default sslPoliciesAggregatedList;
