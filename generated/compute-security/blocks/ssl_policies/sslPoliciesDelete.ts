...
const sslPoliciesDelete: AppBlock = {
  name: "SSL Policies - Delete",
  description: `Deletes the specified SSL policy.`,
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/sslPolicies/{sslPolicy}`;
...
export default sslPoliciesDelete;
