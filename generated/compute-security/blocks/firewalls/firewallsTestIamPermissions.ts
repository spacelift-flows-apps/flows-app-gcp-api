...
const firewallsTestIamPermissions: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/firewalls/{resource}/testIamPermissions`;
...
export default firewallsTestIamPermissions;
