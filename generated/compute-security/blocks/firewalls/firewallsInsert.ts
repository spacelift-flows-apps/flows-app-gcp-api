...
const firewallsInsert: AppBlock = {
  name: "Firewalls - Insert",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.destinationRanges !== undefined)
          body.destinationRanges = input.event.inputConfig.destinationRanges;
        ...
        if (input.event.inputConfig.sourceRanges !== undefined)
          body.sourceRanges = input.event.inputConfig.sourceRanges;
        ...
        if (input.event.inputConfig.sourceTags !== undefined)
          body.sourceTags = input.event.inputConfig.sourceTags;
        ...
        if (input.event.inputConfig.targetTags !== undefined)
          body.targetTags = input.event.inputConfig.targetTags;
...
export default firewallsInsert;
