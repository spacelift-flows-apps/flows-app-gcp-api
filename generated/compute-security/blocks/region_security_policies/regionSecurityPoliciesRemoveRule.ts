...
const regionSecurityPoliciesRemoveRule: AppBlock = {
  name: "Region Security Policies - Remove Rule",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/securityPolicies/{securityPolicy}/removeRule`;
...
export default regionSecurityPoliciesRemoveRule;
