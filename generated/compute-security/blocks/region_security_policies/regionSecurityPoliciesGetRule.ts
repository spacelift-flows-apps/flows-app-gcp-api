...
const regionSecurityPoliciesGetRule: AppBlock = {
  name: "Region Security Policies - Get Rule",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "GET",
          pathTemplate:
            "/compute/v1/projects/{project}/regions/{region}/securityPolicies/{security_policy}/getRule",
          pathParams,
          queryParams,
        });
...
export default regionSecurityPoliciesGetRule;
