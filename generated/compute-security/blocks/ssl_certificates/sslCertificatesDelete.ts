...
const sslCertificatesDelete: AppBlock = {
  name: "SSL Certificates - Delete",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/sslCertificates/{sslCertificate}`;
...
export default sslCertificatesDelete;
