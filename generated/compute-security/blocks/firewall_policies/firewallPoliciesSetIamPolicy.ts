...
const firewallPoliciesSetIamPolicy: AppBlock = {
  name: "Firewall Policies - Set IAM Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `locations/global/firewallPolicies/{resource}/setIamPolicy`;
...
export default firewallPoliciesSetIamPolicy;
