...
const firewallPoliciesGetIamPolicy: AppBlock = {
  name: "Firewall Policies - Get IAM Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `locations/global/firewallPolicies/{resource}/getIamPolicy`;
...
export default firewallPoliciesGetIamPolicy;
