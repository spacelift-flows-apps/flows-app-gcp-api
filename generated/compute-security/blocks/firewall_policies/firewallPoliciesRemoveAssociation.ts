...
const firewallPoliciesRemoveAssociation: AppBlock = {
  name: "Firewall Policies - Remove Association",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `locations/global/firewallPolicies/{firewallPolicy}/removeAssociation`;
...
export default firewallPoliciesRemoveAssociation;
