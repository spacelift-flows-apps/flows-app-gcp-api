...
const regionNetworkFirewallPoliciesAddAssociation: AppBlock = {
  name: "Region Network Firewall Policies - Add Association",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.attachmentTarget !== undefined)
          body.attachmentTarget = input.event.inputConfig.attachmentTarget;
        if (input.event.inputConfig.displayName !== undefined)
          body.displayName = input.event.inputConfig.displayName;
        if (input.event.inputConfig.firewallPolicyId !== undefined)
          body.firewallPolicyId = input.event.inputConfig.firewallPolicyId;
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/regions/{region}/firewallPolicies/{firewall_policy}/addAssociation",
          pathParams,
          queryParams,
...
export default regionNetworkFirewallPoliciesAddAssociation;
