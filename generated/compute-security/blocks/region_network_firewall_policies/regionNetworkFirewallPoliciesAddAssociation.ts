  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/firewallPolicies/{firewallPolicy}/addAssociation`;
        ...
        if (input.event.inputConfig.firewallPolicyId !== undefined)
          requestBody.firewallPolicyId =
            input.event.inputConfig.firewallPolicyId;
        ...
        if (input.event.inputConfig.attachmentTarget !== undefined)
          requestBody.attachmentTarget =
            input.event.inputConfig.attachmentTarget;
