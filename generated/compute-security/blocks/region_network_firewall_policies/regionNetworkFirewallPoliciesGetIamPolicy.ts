...
const regionNetworkFirewallPoliciesGetIamPolicy: AppBlock = {
  name: "Region Network Firewall Policies - Get IAM Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/regions/{region}/firewallPolicies/{resource}/getIamPolicy`;
...
export default regionNetworkFirewallPoliciesGetIamPolicy;
