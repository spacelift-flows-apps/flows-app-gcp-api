...
const regionNetworkFirewallPoliciesCloneRules: AppBlock = {
  name: "Region Network Firewall Policies - Clone Rules",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.sourceFirewallPolicy !== undefined)
          queryParams["sourceFirewallPolicy"] = String(
            input.event.inputConfig.sourceFirewallPolicy,
          );
...
export default regionNetworkFirewallPoliciesCloneRules;
