...
const regionNetworkFirewallPoliciesPatchRule: AppBlock = {
  name: "Region Network Firewall Policies - Patch Rule",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/regions/{region}/firewallPolicies/{firewall_policy}/patchRule",
          pathParams,
          queryParams,
...
export default regionNetworkFirewallPoliciesPatchRule;
