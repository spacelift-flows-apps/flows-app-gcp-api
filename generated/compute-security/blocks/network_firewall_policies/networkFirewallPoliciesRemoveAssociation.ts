...
const networkFirewallPoliciesRemoveAssociation: AppBlock = {
  name: "Network Firewall Policies - Remove Association",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/firewallPolicies/{firewallPolicy}/removeAssociation`;
...
export default networkFirewallPoliciesRemoveAssociation;
