...
const networkFirewallPoliciesRemovePacketMirroringRule: AppBlock = {
  name: "Network Firewall Policies - Remove Packet Mirroring Rule",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/global/firewallPolicies/{firewall_policy}/removePacketMirroringRule",
          pathParams,
          queryParams,
        });
...
export default networkFirewallPoliciesRemovePacketMirroringRule;
