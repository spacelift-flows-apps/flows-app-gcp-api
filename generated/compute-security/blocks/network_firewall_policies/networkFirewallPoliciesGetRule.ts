...
const networkFirewallPoliciesGetRule: AppBlock = {
  name: "Network Firewall Policies - Get Rule",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/firewallPolicies/{firewallPolicy}/getRule`;
...
export default networkFirewallPoliciesGetRule;
