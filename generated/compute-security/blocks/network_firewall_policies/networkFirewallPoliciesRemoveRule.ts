...
const networkFirewallPoliciesRemoveRule: AppBlock = {
  name: "Network Firewall Policies - Remove Rule",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/firewallPolicies/{firewallPolicy}/removeRule`;
...
export default networkFirewallPoliciesRemoveRule;
