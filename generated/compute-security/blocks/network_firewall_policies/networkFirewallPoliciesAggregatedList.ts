...
const networkFirewallPoliciesAggregatedList: AppBlock = {
  name: "Network Firewall Policies - Aggregated List",
      ...
      type: {
        ...
        properties: {
          ...
          kind: {
            type: "string",
            description:
              "Output only. [Output Only] Type of resource. Alwayscompute#networkFirewallPoliciesAggregatedList for lists of network firewall policies.",
          },
          nextPageToken: {
            type: "string",
            description:
...
export default networkFirewallPoliciesAggregatedList;
