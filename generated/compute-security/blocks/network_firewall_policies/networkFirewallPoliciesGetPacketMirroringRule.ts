...
const networkFirewallPoliciesGetPacketMirroringRule: AppBlock = {
  name: "Network Firewall Policies - Get Packet Mirroring Rule",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "GET",
          pathTemplate:
            "/compute/v1/projects/{project}/global/firewallPolicies/{firewall_policy}/getPacketMirroringRule",
          pathParams,
          queryParams,
        });
...
export default networkFirewallPoliciesGetPacketMirroringRule;
