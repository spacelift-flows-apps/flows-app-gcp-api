...
const networkFirewallPoliciesSetIamPolicy: AppBlock = {
  name: "Network Firewall Policies - Set IAM Policy",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/firewallPolicies/{resource}/setIamPolicy`;
...
export default networkFirewallPoliciesSetIamPolicy;
