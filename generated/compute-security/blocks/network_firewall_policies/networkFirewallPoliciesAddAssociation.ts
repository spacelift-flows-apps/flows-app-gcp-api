...
const networkFirewallPoliciesAddAssociation: AppBlock = {
  name: "Network Firewall Policies - Add Association",
...
export default networkFirewallPoliciesAddAssociation;
