...
const securityPoliciesRemoveRule: AppBlock = {
  name: "Security Policies - Remove Rule",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `projects/{project}/global/securityPolicies/{securityPolicy}/removeRule`;
...
export default securityPoliciesRemoveRule;
