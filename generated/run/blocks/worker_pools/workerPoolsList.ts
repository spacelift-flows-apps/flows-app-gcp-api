...
const workerPoolsList: AppBlock = {
  name: "Worker Pools - List",
  description: `Lists WorkerPools.`,
                  ...
                  items: {
                    ...
                    properties: {
                      ...
                      percent: {
                        type: "integer",
                        description:
                          "Specifies percent of the instance split to this Revision. This defaults to zero if unspecified. (Format: int32)",
                      },
                    },
                    description:
                ...
                scaling: {
                  ...
                  properties: {
                    manualInstanceCount: {
                      type: "integer",
                      description:
                        "Optional. The total number of instances in manual scaling mode. (Format: int32)",
                    },
                  },
                  ...
                  items: {
                    ...
                    properties: {
                      ...
                      percent: {
                        type: "integer",
                        description:
                          "Specifies percent of the instance split to this Revision. (Format: int32)",
                      },
                    },
                    description:
...
export default workerPoolsList;
