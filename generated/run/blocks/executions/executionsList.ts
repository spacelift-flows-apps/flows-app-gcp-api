            ...
            items: {
              ...
              properties: {
                ...
                createTime: {
                  type: "string",
                  description:
                    "Output only. Represents time when the execution was acknowledged by the execution controller. It is not guaranteed to be set in happens-before order across separate operations. (Format: google-datetime)",
                },
                startTime: {
                  type: "string",
                  description:
                    "Output only. Represents time when the execution started to run. It is not guaranteed to be set in happens-before order across separate operations. (Format: google-datetime)",
                },
                completionTime: {
                  type: "string",
                  description:
                    "Output only. Represents time when the execution was completed. It is not guaranteed to be set in happens-before order across separate operations. (Format: google-datetime)",
                },
                updateTime: {
                  type: "string",
                  description:
                ...
                parallelism: {
                  type: "integer",
                  description:
                    "Output only. Specifies the maximum desired number of tasks the execution should run at any given time. Must be <= task_count. The actual number of tasks running in steady state will be less than this number when ((.spec.task_count - .status.successful) < .spec.parallelism), i.e. when the work left to do is less than max parallelism. (Format: int32)",
                },
                taskCount: {
                  type: "integer",
                  description:
                    "Output only. Specifies the desired number of tasks the execution should run. Setting to 1 means that parallelism is limited to 1 and the success of that task signals the success of the execution. (Format: int32)",
                },
                template: {
                  type: "object",
                  properties: {
                ...
                observedGeneration: {
                  type: "string",
                  description:
                    "Output only. The generation of this Execution. See comments in `reconciling` for additional information on reconciliation process in Cloud Run. (Format: int64)",
                },
                runningCount: {
                  type: "integer",
                  description:
                    "Output only. The number of actively running tasks. (Format: int32)",
                },
                succeededCount: {
                  type: "integer",
                  description:
                    "Output only. The number of tasks which reached phase Succeeded. (Format: int32)",
                },
                failedCount: {
                  type: "integer",
                  description:
                    "Output only. The number of tasks which reached phase Failed. (Format: int32)",
                },
                cancelledCount: {
                  type: "integer",
                  description:
                    "Output only. The number of tasks which reached phase Cancelled. (Format: int32)",
                },
                retriedCount: {
                  type: "integer",
                  description:
                    "Output only. The number of tasks which have retried at least once. (Format: int32)",
                },
                logUri: {
                  type: "string",
                  description:
