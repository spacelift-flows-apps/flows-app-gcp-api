            ...
            items: {
              ...
              properties: {
                ...
                expireTime: {
                  type: "string",
                  description:
                    "Output only. For a deleted resource, the time after which it will be permamently deleted. (Format: google-datetime)",
                },
                creator: {
                  type: "string",
                  description:
                ...
                observedGeneration: {
                  type: "string",
                  description:
                    "Output only. The generation of this Job. See comments in `reconciling` for additional information on reconciliation process in Cloud Run. (Format: int64)",
                },
                terminalCondition: {
                  type: "object",
                  properties: {
                ...
                executionCount: {
                  type: "integer",
                  description:
                    "Output only. Number of executions created for this job. (Format: int32)",
                },
                latestCreatedExecution: {
                  ...
                  properties: {
                    ...
                    createTime: {
                      type: "string",
                      description:
                        "Creation timestamp of the execution. (Format: google-datetime)",
                    },
                    completionTime: {
                      type: "string",
                      description:
                    ...
                    deleteTime: {
                      type: "string",
                      description:
                        "The deletion time of the execution. It is only populated as a response to a Delete request. (Format: google-datetime)",
                    },
                    completionStatus: {
                      type: "string",
                      enum: [
