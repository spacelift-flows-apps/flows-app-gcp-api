...
const ekmConnectionsTestIamPermissions: AppBlock = {
  name: "EKM Connections - Test IAM Permissions",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/{+resource}:testIamPermissions`;
...
export default ekmConnectionsTestIamPermissions;
