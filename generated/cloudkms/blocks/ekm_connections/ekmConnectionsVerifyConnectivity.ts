...
const ekmConnectionsVerifyConnectivity: AppBlock = {
  name: "EKM Connections - Verify Connectivity",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/{+name}:verifyConnectivity`;
...
export default ekmConnectionsVerifyConnectivity;
