...
const sslCertsDelete: AppBlock = {
  name: "SSL Certs - Delete",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{project}/instances/{instance}/sslCerts/{sha1Fingerprint}`;
