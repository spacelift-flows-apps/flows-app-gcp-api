...
const databasesPatch: AppBlock = {
  name: "Databases - Patch",
  description: `Partially updates a resource containing information about a database inside a Cloud SQL instance.`,
  category: "Databases",
  inputs: {
    default: {
      config: {
        ...
        sqlserverDatabaseDetails: {
          name: "Sqlserver Database Details",
          description: "Request body field: sqlserverDatabaseDetails",
          type: {
            type: "object",
            properties: {
              compatibilityLevel: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.charset !== undefined)
          requestBody.charset = input.event.inputConfig.charset;
        if (input.event.inputConfig.collation !== undefined)
          requestBody.collation = input.event.inputConfig.collation;
        ...
        if (input.event.inputConfig.sqlserverDatabaseDetails !== undefined)
          requestBody.sqlserverDatabaseDetails =
            input.event.inputConfig.sqlserverDatabaseDetails;
