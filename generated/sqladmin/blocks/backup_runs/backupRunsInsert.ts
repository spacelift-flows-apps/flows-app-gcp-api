...
const backupRunsInsert: AppBlock = {
  name: "Backup Runs - Insert",
    ...
    default: {
      config: {
        ...
        enqueuedTime: {
          name: "Enqueued Time",
          description:
            "The time the run was enqueued in UTC timezone in [RFC 3339](https://tools.",
          type: {
            type: "string",
            description:
        ...
        id: {
          name: "ID",
          description: "The identifier for this backup run.",
          type: {
            type: "string",
            description:
        ...
        startTime: {
          name: "Start Time",
          description:
            "The time the backup operation actually started in UTC timezone in [RFC 3339](https://tools.",
          type: {
            type: "string",
            description:
        ...
        endTime: {
          name: "End Time",
          description:
            "The time the backup operation completed in UTC timezone in [RFC 3339](https://tools.",
          type: {
            type: "string",
            description:
        ...
        error: {
          name: "Error",
          description: "Information about why the backup operation failed.",
          type: {
            type: "object",
            properties: {
              kind: {
        ...
        windowStartTime: {
          ...
          description:
            "The start time of the backup window during which this the backup was attempted in [RFC 3339](https://tools.",
          type: {
            type: "string",
            description:
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.enqueuedTime !== undefined)
          requestBody.enqueuedTime = input.event.inputConfig.enqueuedTime;
        if (input.event.inputConfig.id !== undefined)
          requestBody.id = input.event.inputConfig.id;
        if (input.event.inputConfig.startTime !== undefined)
          requestBody.startTime = input.event.inputConfig.startTime;
        if (input.event.inputConfig.endTime !== undefined)
          requestBody.endTime = input.event.inputConfig.endTime;
        ...
        if (input.event.inputConfig.windowStartTime !== undefined)
          requestBody.windowStartTime = input.event.inputConfig.windowStartTime;
...
export default backupRunsInsert;
