      ...
      type: {
        ...
        properties: {
          ...
          backupInterval: {
            ...
            properties: {
              startTime: {
                type: "string",
                description:
                  "Optional. Inclusive start of the interval. If specified, a Timestamp matching this interval will have to be the same or after the start. (Format: google-datetime)",
              },
              endTime: {
                type: "string",
                description:
                  "Optional. Exclusive end of the interval. If specified, a Timestamp matching this interval will have to be before the end. (Format: google-datetime)",
              },
            },
            description:
          ...
          instanceDeletionTime: {
            type: "string",
            description:
              "Optional. Output only. Timestamp in UTC of when the instance associated with this backup is deleted. (Format: google-datetime)",
          },
          instanceSettings: {
            type: "object",
            properties: {
