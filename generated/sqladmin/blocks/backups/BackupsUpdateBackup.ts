...
const BackupsUpdateBackup: AppBlock = {
  name: "Backups - Update Backup",
  description: `Updates the retention period and description of the backup.`,
  category: "Backups",
  inputs: {
    default: {
      config: {
...
export default BackupsUpdateBackup;
