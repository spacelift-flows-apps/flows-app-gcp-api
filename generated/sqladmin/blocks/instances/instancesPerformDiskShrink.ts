...
const instancesPerformDiskShrink: AppBlock = {
  name: "Instances - Perform Disk Shrink",
  ...
  inputs: {
    default: {
      config: {
        ...
        targetSizeGb: {
          ...
          type: {
            type: "string",
            description:
              "The target disk shrink size in GigaBytes. (Format: int64)",
          },
          required: false,
        },
      },
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{project}/instances/{instance}/performDiskShrink`;
        ...
        if (input.event.inputConfig.targetSizeGb !== undefined)
          requestBody.targetSizeGb = input.event.inputConfig.targetSizeGb;
...
export default instancesPerformDiskShrink;
