...
const instancesStopReplica: AppBlock = {
  name: "Instances - Stop Replica",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{project}/instances/{instance}/stopReplica`;
...
export default instancesStopReplica;
