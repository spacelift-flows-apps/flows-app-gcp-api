...
const instancesStartExternalSync: AppBlock = {
  name: "Instances - Start External Sync",
    ...
    default: {
      config: {
        ...
        replicaOverwriteEnabled: {
          name: "Replica Overwrite Enabled",
          description: "Optional.",
          type: {
            type: "boolean",
            description:
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{project}/instances/{instance}/startExternalSync`;
        ...
        if (input.event.inputConfig.skipVerification !== undefined)
          requestBody.skipVerification =
            input.event.inputConfig.skipVerification;
        ...
        if (input.event.inputConfig.replicaOverwriteEnabled !== undefined)
          requestBody.replicaOverwriteEnabled =
            input.event.inputConfig.replicaOverwriteEnabled;
...
export default instancesStartExternalSync;
