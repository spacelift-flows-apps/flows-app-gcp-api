...
const instancesImport: AppBlock = {
  name: "Instances - Import",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{project}/instances/{instance}/import`;
        ...
        if (input.event.inputConfig.importContext !== undefined)
          requestBody.importContext = input.event.inputConfig.importContext;
...
export default instancesImport;
