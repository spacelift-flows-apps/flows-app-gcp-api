...
const instancesPromoteReplica: AppBlock = {
  name: "Instances - Promote Replica",
  description: `Promotes the read replica instance to be an independent Cloud SQL primary instance.`,
  category: "Instances",
  inputs: {
    default: {
      config: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{project}/instances/{instance}/promoteReplica`;
...
export default instancesPromoteReplica;
