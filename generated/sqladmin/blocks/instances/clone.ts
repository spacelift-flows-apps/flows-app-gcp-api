  ...
  body: {
    ...
    fields: {
      cloneContext: {
        name: "clone_context",
        fields: {
          pitrTimestampMs: "pitr_timestamp_ms",
          destinationInstanceName: "destination_instance_name",
          binLogCoordinates: {
            name: "bin_log_coordinates",
            fields: {
              binLogFileName: "bin_log_file_name",
              binLogPosition: "bin_log_position",
            },
          },
          ...
          preferredSecondaryZone: "preferred_secondary_zone",
    ...
    default: {
          ...
          type: {
            ...
            properties: {
              cloneContext: {
                ...
                required: ["destinationInstanceName"],
                description: "Database instance clone context.",
                additionalProperties: true,
              },
            },
            required: ["cloneContext"],
      ...
      onEvent: async (input) => {
        ...
        const result = await new Promise<any>((resolve, reject) => {
          client.clone(request, (err: any, response: any) => {
            if (err)
              reject(
                new Error(
