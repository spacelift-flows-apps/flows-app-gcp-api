...
const instancesReencrypt: AppBlock = {
  name: "Instances - Reencrypt",
    ...
    default: {
      config: {
        ...
        backupReencryptionConfig: {
          name: "Backup Reencryption Config",
          ...
          type: {
            ...
            properties: {
              backupLimit: {
                type: "integer",
                description: "Backup re-encryption limit (Format: int32)",
              },
              backupType: {
                type: "string",
                enum: ["BACKUP_TYPE_UNSPECIFIED", "AUTOMATED", "ON_DEMAND"],
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{project}/instances/{instance}/reencrypt`;
        ...
        if (input.event.inputConfig.backupReencryptionConfig !== undefined)
          requestBody.backupReencryptionConfig =
            input.event.inputConfig.backupReencryptionConfig;
...
export default instancesReencrypt;
