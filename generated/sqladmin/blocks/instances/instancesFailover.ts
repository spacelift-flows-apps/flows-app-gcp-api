...
const instancesFailover: AppBlock = {
  name: "Instances - Failover",
  description: `Initiates a manual failover of a high availability (HA) primary instance to a standby instance, which becomes the primary instance.`,
  category: "Instances",
  inputs: {
    default: {
      config: {
          ...
          type: {
            ...
            properties: {
              settingsVersion: {
                type: "string",
                description:
                  "The current settings version of this instance. Request will be rejected if this version doesn't match the current settings version. (Format: int64)",
              },
              kind: {
                type: "string",
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{project}/instances/{instance}/failover`;
        ...
        if (input.event.inputConfig.failoverContext !== undefined)
          requestBody.failoverContext = input.event.inputConfig.failoverContext;
...
export default instancesFailover;
