...
const instancesRotateServerCa: AppBlock = {
  name: "Instances - Rotate Server CA",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{project}/instances/{instance}/rotateServerCa`;
        ...
        if (input.event.inputConfig.rotateServerCaContext !== undefined)
          requestBody.rotateServerCaContext =
            input.event.inputConfig.rotateServerCaContext;
...
export default instancesRotateServerCa;
