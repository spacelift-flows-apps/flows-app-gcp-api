...
const instancesRescheduleMaintenance: AppBlock = {
  name: "Instances - Reschedule Maintenance",
  ...
  inputs: {
    default: {
          ...
          type: {
            ...
            properties: {
              ...
              scheduleTime: {
                type: "string",
                description:
                  "Optional. Timestamp when the maintenance shall be rescheduled to if reschedule_type=SPECIFIC_TIME, in [RFC 3339](https://tools.ietf.org/html/rfc3339) format, for example `2012-11-15T16:19:00.094Z`. (Format: google-datetime)",
              },
            },
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{project}/instances/{instance}/rescheduleMaintenance`;
        ...
        if (input.event.inputConfig.reschedule !== undefined)
          requestBody.reschedule = input.event.inputConfig.reschedule;
...
export default instancesRescheduleMaintenance;
