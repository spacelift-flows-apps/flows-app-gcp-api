...
const instancesStartReplica: AppBlock = {
  name: "Instances - Start Replica",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{project}/instances/{instance}/startReplica`;
...
export default instancesStartReplica;
