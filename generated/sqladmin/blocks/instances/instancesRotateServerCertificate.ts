...
const instancesRotateServerCertificate: AppBlock = {
  name: "Instances - Rotate Server Certificate",
  description: `Rotates the server certificate version to one previously added with the addServerCertificate method.`,
  category: "Instances",
  inputs: {
    default: {
      config: {
        ...
        rotateServerCertificateContext: {
          name: "Rotate Server Certificate Context",
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{project}/instances/{instance}/rotateServerCertificate`;
        ...
        if (
          input.event.inputConfig.rotateServerCertificateContext !== undefined
        )
          requestBody.rotateServerCertificateContext =
            input.event.inputConfig.rotateServerCertificateContext;
...
export default instancesRotateServerCertificate;
