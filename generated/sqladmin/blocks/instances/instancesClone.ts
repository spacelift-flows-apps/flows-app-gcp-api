  ...
  inputs: {
    default: {
        ...
        cloneContext: {
          ...
          type: {
            ...
            properties: {
              ...
              pitrTimestampMs: {
                type: "string",
                description: "Reserved for future use. (Format: int64)",
              },
              ...
              binLogCoordinates: {
                ...
                properties: {
                  ...
                  binLogPosition: {
                    type: "string",
                    description:
                      "Position (offset) within the binary log file. (Format: int64)",
                  },
                  kind: {
                    type: "string",
              ...
              pointInTime: {
                type: "string",
                description:
                  "Timestamp, if specified, identifies the time to which the source instance is cloned. (Format: google-datetime)",
              },
              allocatedIpRange: {
                type: "string",
                description:
              ...
              sourceInstanceDeletionTime: {
                type: "string",
                description:
                  "The timestamp used to identify the time when the source instance is deleted. If this instance is deleted, then you must set the timestamp. (Format: google-datetime)",
              },
            },
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{project}/instances/{instance}/clone`;
        ...
        if (input.event.inputConfig.cloneContext !== undefined)
          requestBody.cloneContext = input.event.inputConfig.cloneContext;
