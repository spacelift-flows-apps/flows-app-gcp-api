...
const instancesTruncateLog: AppBlock = {
  name: "Instances - Truncate Log",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{project}/instances/{instance}/truncateLog`;
        ...
        if (input.event.inputConfig.truncateLogContext !== undefined)
          requestBody.truncateLogContext =
            input.event.inputConfig.truncateLogContext;
...
export default instancesTruncateLog;
