...
const instancesRotateEntraIdCertificate: AppBlock = {
  name: "Instances - Rotate Entra ID Certificate",
    ...
    default: {
      config: {
        ...
        rotateEntraIdCertificateContext: {
          name: "Rotate Entra ID Certificate Context",
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{project}/instances/{instance}/rotateEntraIdCertificate`;
        ...
        if (
          input.event.inputConfig.rotateEntraIdCertificateContext !== undefined
        )
          requestBody.rotateEntraIdCertificateContext =
            input.event.inputConfig.rotateEntraIdCertificateContext;
...
export default instancesRotateEntraIdCertificate;
