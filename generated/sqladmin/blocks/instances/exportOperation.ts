  ...
  body: {
    ...
    fields: {
      exportContext: {
        ...
        fields: {
          sqlExportOptions: {
            name: "sql_export_options",
            fields: {
              schemaOnly: "schema_only",
              mysqlExportOptions: {
                name: "mysql_export_options",
                fields: {
                  masterData: "master_data",
                },
              },
              postgresExportOptions: {
                name: "postgres_export_options",
                fields: {
                  ifExists: "if_exists",
                },
              },
          ...
          fileType: "file_type",
          bakExportOptions: {
            name: "bak_export_options",
            fields: {
              stripeCount: "stripe_count",
              bakType: "bak_type",
              copyOnly: "copy_only",
              differentialBase: "differential_base",
              exportLogStartTime: "export_log_start_time",
              exportLogEndTime: "export_log_end_time",
            },
          },
          tdeExportOptions: {
            name: "tde_export_options",
            fields: {
...
const exportOperation: AppBlock = {
  name: "Export",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await new Promise<any>((resolve, reject) => {
          client.export(request, (err: any, response: any) => {
            if (err)
              reject(
                new Error(
