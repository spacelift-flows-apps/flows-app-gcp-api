...
const instancesAddServerCertificate: AppBlock = {
  name: "Instances - Add Server Certificate",
  description: `Add a new trusted server certificate version for the specified instance using Certificate Authority Service (CAS) server CA.`,
  category: "Instances",
  inputs: {
    default: {
      config: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{project}/instances/{instance}/addServerCertificate`;
...
export default instancesAddServerCertificate;
