  ...
  body: {
    ...
    fields: {
      rotateEntraIdCertificateContext: {
        name: "rotate_entra_id_certificate_context",
        fields: {
...
const rotateEntraIdCertificate: AppBlock = {
  ...
  inputs: {
    default: {
      config: {
        ...
        body: {
          name: "Body",
          description: "Optional. Rotate Entra ID certificate request body.",
          type: {
            type: "object",
            properties: {
              rotateEntraIdCertificateContext: {
      ...
      onEvent: async (input) => {
        ...
        const result = await new Promise<any>((resolve, reject) => {
          client.rotateEntraIdCertificate(
            request,
...
export default rotateEntraIdCertificate;
