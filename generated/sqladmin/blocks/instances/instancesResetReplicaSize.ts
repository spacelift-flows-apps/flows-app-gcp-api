...
const instancesResetReplicaSize: AppBlock = {
  name: "Instances - Reset Replica Size",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{project}/instances/{instance}/resetReplicaSize`;
...
export default instancesResetReplicaSize;
