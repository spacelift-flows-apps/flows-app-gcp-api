...
const instancesDemote: AppBlock = {
  name: "Instances - Demote",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{project}/instances/{instance}/demote`;
        ...
        if (input.event.inputConfig.demoteContext !== undefined)
          requestBody.demoteContext = input.event.inputConfig.demoteContext;
...
export default instancesDemote;
