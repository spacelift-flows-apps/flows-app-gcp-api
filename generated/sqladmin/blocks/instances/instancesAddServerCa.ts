...
const instancesAddServerCa: AppBlock = {
  name: "Instances - Add Server CA",
  description: `Adds a new trusted Certificate Authority (CA) version for the specified instance.`,
  category: "Instances",
  inputs: {
    default: {
      config: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{project}/instances/{instance}/addServerCa`;
...
export default instancesAddServerCa;
