  ...
  body: {
    ...
    fields: {
      rotateServerCertificateContext: {
        name: "rotate_server_certificate_context",
        fields: {
...
const rotateServerCertificate: AppBlock = {
  ...
  inputs: {
    default: {
      config: {
        ...
        body: {
          name: "Body",
          description: "Optional. Rotate server certificate request body.",
          type: {
            type: "object",
            properties: {
              rotateServerCertificateContext: {
      ...
      onEvent: async (input) => {
        ...
        const result = await new Promise<any>((resolve, reject) => {
          client.rotateServerCertificate(request, (err: any, response: any) => {
            if (err)
              reject(
                new Error(
...
export default rotateServerCertificate;
