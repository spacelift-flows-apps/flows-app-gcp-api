...
const instancesResetSslConfig: AppBlock = {
  name: "Instances - Reset SSL Config",
    ...
    default: {
      config: {
        ...
        mode: {
          ...
          type: {
            type: "string",
            enum: ["RESET_SSL_MODE_UNSPECIFIED", "ALL", "SYNC_FROM_PRIMARY"],
          },
          required: false,
        },
      },
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{project}/instances/{instance}/resetSslConfig`;
...
export default instancesResetSslConfig;
