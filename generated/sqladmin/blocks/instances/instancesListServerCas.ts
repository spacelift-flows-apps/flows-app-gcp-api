...
const instancesListServerCas: AppBlock = {
  name: "Instances - List Server CAs",
  description: `Lists all of the trusted Certificate Authorities (CAs) for the specified instance.`,
  category: "Instances",
  inputs: {
    default: {
      config: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{project}/instances/{instance}/listServerCas`;
...
export default instancesListServerCas;
