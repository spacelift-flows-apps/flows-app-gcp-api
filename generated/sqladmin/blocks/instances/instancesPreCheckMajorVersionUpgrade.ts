...
const instancesPreCheckMajorVersionUpgrade: AppBlock = {
  name: "Instances - Pre Check Major Version Upgrade",
    ...
    default: {
      config: {
        ...
        preCheckMajorVersionUpgradeContext: {
          name: "Pre Check Major Version Upgrade Context",
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{project}/instances/{instance}/preCheckMajorVersionUpgrade`;
        ...
        if (
          input.event.inputConfig.preCheckMajorVersionUpgradeContext !==
          undefined
        )
          requestBody.preCheckMajorVersionUpgradeContext =
            input.event.inputConfig.preCheckMajorVersionUpgradeContext;
...
export default instancesPreCheckMajorVersionUpgrade;
