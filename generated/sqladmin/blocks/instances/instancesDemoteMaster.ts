...
const instancesDemoteMaster: AppBlock = {
  name: "Instances - Demote Master",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        let path = `v1/projects/{project}/instances/{instance}/demoteMaster`;
        ...
        if (input.event.inputConfig.demoteMasterContext !== undefined)
          requestBody.demoteMasterContext =
            input.event.inputConfig.demoteMasterContext;
...
export default instancesDemoteMaster;
