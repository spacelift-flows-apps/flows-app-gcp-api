...
const regionSslPoliciesInsert: AppBlock = {
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.customFeatures !== undefined)
          body.customFeatures = input.event.inputConfig.customFeatures;
        if (input.event.inputConfig.description !== undefined)
          body.description = input.event.inputConfig.description;
        if (input.event.inputConfig.enabledFeatures !== undefined)
          body.enabledFeatures = input.event.inputConfig.enabledFeatures;
        ...
        if (input.event.inputConfig.minTlsVersion !== undefined)
          body.minTlsVersion = input.event.inputConfig.minTlsVersion;
...
export default regionSslPoliciesInsert;
