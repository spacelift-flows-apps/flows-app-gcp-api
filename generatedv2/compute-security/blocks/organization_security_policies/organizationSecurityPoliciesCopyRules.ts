...
const organizationSecurityPoliciesCopyRules: AppBlock = {
  name: "Organization Security Policies - Copy Rules",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.sourceSecurityPolicy !== undefined)
          queryParams["sourceSecurityPolicy"] = String(
            input.event.inputConfig.sourceSecurityPolicy,
          );
...
export default organizationSecurityPoliciesCopyRules;
