...
const organizationSecurityPoliciesList: AppBlock = {
  name: "Organization Security Policies - List",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "GET",
          pathTemplate: "/compute/v1/locations/global/securityPolicies",
          pathParams,
          queryParams,
        });
...
export default organizationSecurityPoliciesList;
