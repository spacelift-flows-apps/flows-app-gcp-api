...
const networkFirewallPoliciesPatchPacketMirroringRule: AppBlock = {
  name: "Network Firewall Policies - Patch Packet Mirroring Rule",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/global/firewallPolicies/{firewall_policy}/patchPacketMirroringRule",
          pathParams,
          queryParams,
...
export default networkFirewallPoliciesPatchPacketMirroringRule;
