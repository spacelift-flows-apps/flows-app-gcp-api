...
const securityPoliciesAggregatedList: AppBlock = {
  name: "Security Policies - Aggregated List",
      ...
      type: {
        ...
        properties: {
          ...
          kind: {
            type: "string",
            description:
              "Output only. [Output Only] Type of resource. Alwayscompute#securityPolicyAggregatedList for lists of Security Policies.",
          },
          nextPageToken: {
            type: "string",
            description:
...
export default securityPoliciesAggregatedList;
