...
const regionNetworkFirewallPoliciesPatch: AppBlock = {
  name: "Region Network Firewall Policies - Patch",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "PATCH",
          pathTemplate:
            "/compute/v1/projects/{project}/regions/{region}/firewallPolicies/{firewall_policy}",
          pathParams,
          queryParams,
...
export default regionNetworkFirewallPoliciesPatch;
