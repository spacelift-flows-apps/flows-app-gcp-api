  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.attachment_target !== undefined)
          body.attachment_target = input.event.inputConfig.attachment_target;
        if (input.event.inputConfig.display_name !== undefined)
          body.display_name = input.event.inputConfig.display_name;
        if (input.event.inputConfig.firewall_policy_id !== undefined)
          body.firewall_policy_id = input.event.inputConfig.firewall_policy_id;
