...
const regionNetworkFirewallPoliciesRemoveAssociation: AppBlock = {
  name: "Region Network Firewall Policies - Remove Association",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/regions/{region}/firewallPolicies/{firewall_policy}/removeAssociation",
          pathParams,
          queryParams,
        });
...
export default regionNetworkFirewallPoliciesRemoveAssociation;
