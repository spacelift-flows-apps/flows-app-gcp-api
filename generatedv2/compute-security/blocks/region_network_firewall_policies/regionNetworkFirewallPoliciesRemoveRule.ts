...
const regionNetworkFirewallPoliciesRemoveRule: AppBlock = {
  name: "Region Network Firewall Policies - Remove Rule",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/regions/{region}/firewallPolicies/{firewall_policy}/removeRule",
          pathParams,
          queryParams,
        });
...
export default regionNetworkFirewallPoliciesRemoveRule;
