...
const sslCertificatesInsert: AppBlock = {
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.expireTime !== undefined)
          body.expireTime = input.event.inputConfig.expireTime;
        ...
        if (input.event.inputConfig.privateKey !== undefined)
          body.privateKey = input.event.inputConfig.privateKey;
        ...
        if (input.event.inputConfig.selfManaged !== undefined)
          body.selfManaged = input.event.inputConfig.selfManaged;
...
export default sslCertificatesInsert;
