    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.certificate !== undefined)
          body.certificate = input.event.inputConfig.certificate;
        ...
        if (input.event.inputConfig.expire_time !== undefined)
          body.expire_time = input.event.inputConfig.expire_time;
        ...
        if (input.event.inputConfig.managed !== undefined)
          body.managed = input.event.inputConfig.managed;
        if (input.event.inputConfig.name !== undefined)
          body.name = input.event.inputConfig.name;
        if (input.event.inputConfig.private_key !== undefined)
          body.private_key = input.event.inputConfig.private_key;
        ...
        if (input.event.inputConfig.self_managed !== undefined)
          body.self_managed = input.event.inputConfig.self_managed;
        if (input.event.inputConfig.subject_alternative_names !== undefined)
          body.subject_alternative_names =
            input.event.inputConfig.subject_alternative_names;
