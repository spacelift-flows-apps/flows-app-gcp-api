  ...
  bucket: {
    ...
    fields: {
      ...
      encryption: {
        name: "encryption",
        fields: {
          defaultKmsKey: "default_kms_key",
          googleManagedEncryptionEnforcementConfig: {
            name: "google_managed_encryption_enforcement_config",
            fields: {
          ...
          customerManagedEncryptionEnforcementConfig: {
            name: "customer_managed_encryption_enforcement_config",
            fields: {
              restrictionMode: "restriction_mode",
              effectiveTime: "effective_time",
            },
          ...
          customerSuppliedEncryptionEnforcementConfig: {
            name: "customer_supplied_encryption_enforcement_config",
            fields: {
              restrictionMode: "restriction_mode",
              effectiveTime: "effective_time",
            },
      ...
      objectRetention: "object_retention",
      ipFilter: {
        name: "ip_filter",
        fields: {
          publicNetworkSource: {
            name: "public_network_source",
            fields: {
