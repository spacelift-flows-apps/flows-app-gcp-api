  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.restore_token !== undefined)
          request.restore_token = input.event.inputConfig.restore_token;
        ...
        if (input.event.inputConfig.copy_source_acl !== undefined)
          request.copy_source_acl = input.event.inputConfig.copy_source_acl;
