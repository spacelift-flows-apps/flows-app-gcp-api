...
const inputMapping = {
  ...
  destinationKmsKey: "destination_kms_key",
  destination: {
    name: "destination",
    fields: {
  ...
  destinationPredefinedAcl: "destination_predefined_acl",
  ...
  ifSourceGenerationNotMatch: "if_source_generation_not_match",
  ifSourceMetagenerationMatch: "if_source_metageneration_match",
  ifSourceMetagenerationNotMatch: "if_source_metageneration_not_match",
  maxBytesRewrittenPerCall: "max_bytes_rewritten_per_call",
  copySourceEncryptionAlgorithm: "copy_source_encryption_algorithm",
  copySourceEncryptionKeyBytes: "copy_source_encryption_key_bytes",
  copySourceEncryptionKeySha256Bytes: "copy_source_encryption_key_sha256_bytes",
