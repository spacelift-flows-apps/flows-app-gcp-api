...
const startAsyncReplication: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.async_secondary_disk !== undefined)
          body.async_secondary_disk =
            input.event.inputConfig.async_secondary_disk;
...
export default startAsyncReplication;
