...
import { getWorkerPoolsClient, createRoutingMetadata, convertKeys } from "../../lib/grpcClient.ts";
...
const inputMapping = {
  ...
  "workerPool": {
    ...
    "fields": {
      ...
      "instanceSplits": "instance_splits",
      "scaling": {
        "name": "scaling",
        "fields": {
  ...
  "forceNewRevision": "force_new_revision"
};
  ...
  inputs: {
    default: {
      config: {
        ...
        workerPool: {
          name: "Worker Pool",
          description: "Required. The WorkerPool to be updated.",
          type: {
                    "type": "object",
                    "properties": {
                              "name": {
                              ...
                              "annotations": {
                                        ...
                                        "description": "Optional. Unstructured key value map that may be set by external tools to store and arbitrary metadata. They are not queryable and should be preserved when modifying objects.  Cloud Run API v2 does not support annotations with `run.googleapis.com`, `cloud.googleapis.com`, `serving.knative.dev`, or `autoscaling.knative.dev` namespaces, and they will be rejected in new resources. All system annotations in v1 now have a corresponding field in v2 WorkerPool.  <p>This field follows Kubernetes annotations' namespacing, limits, and rules."
                              },
                              "client": {
                                        "type": "string",
                                        ...
                                        "items": {
                                                  ...
                                                  "properties": {
                                                            "type": {
                                                                      ...
                                                                      "description": "The type of instance split allocation."
                                                            },
                                                            "revision": {
                                                                      "type": "string",
      ...
      onEvent: async (input) => {
        ...
        const result = await new Promise<any>((resolve, reject) => {
          client.updateWorkerPool(request, metadata, (err: any, response: any) => {
