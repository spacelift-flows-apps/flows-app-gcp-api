...
import { getWorkerPoolsClient } from "../../lib/grpcClient.ts";

const workerPoolsTestIamPermissions: AppBlock = {
  name: "WorkerPools - Test IAM Permissions",
...
export default workerPoolsTestIamPermissions;
