  ...
  inputs: {
    default: {
      config: {
        ...
        validateOnly: {
          name: "Validate Only",
          description: "Optional. Indicates that the request should be validated without actually stopping any resources.",
          type: {
                    "type": "boolean",
                    "description": "Optional. Indicates that the request should be validated without actually stopping any resources."
          },
        ...
        etag: {
          name: "Etag",
          description: "Optional. A system-generated fingerprint for this version of the resource. This may be used to detect modification conflict during updates.",
          type: {
                    "type": "string",
                    "description": "Optional. A system-generated fingerprint for this version of the resource. This may be used to detect modification conflict during updates."
          },
      ...
      onEvent: async (input) => {
        ...
        const result = await new Promise<any>((resolve, reject) => {
          client.startInstance(request, (err: any, response: any) => {
