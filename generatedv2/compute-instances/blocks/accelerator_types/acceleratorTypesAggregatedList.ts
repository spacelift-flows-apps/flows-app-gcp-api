...
const acceleratorTypesAggregatedList: AppBlock = {
  name: "Accelerator Types - Aggregated List",
      ...
      type: {
        ...
        properties: {
          ...
          kind: {
            type: "string",
            description:
              "Output only. [Output Only] Type of resource. Alwayscompute#acceleratorTypeAggregatedList for aggregated lists of accelerator types.",
          },
          nextPageToken: {
            type: "string",
            description:
...
export default acceleratorTypesAggregatedList;
