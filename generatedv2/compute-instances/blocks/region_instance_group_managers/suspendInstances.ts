...
const suspendInstances: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.force_suspend !== undefined)
          body.force_suspend = input.event.inputConfig.force_suspend;
...
export default suspendInstances;
