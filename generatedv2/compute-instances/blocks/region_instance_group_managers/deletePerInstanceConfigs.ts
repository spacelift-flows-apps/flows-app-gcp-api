...
const deletePerInstanceConfigs: AppBlock = {
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.names !== undefined)
          body.names = input.event.inputConfig.names;

        const result = await computeFetch({
          config: input.app.config,
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/deletePerInstanceConfigs",
          pathParams,
...
export default deletePerInstanceConfigs;
