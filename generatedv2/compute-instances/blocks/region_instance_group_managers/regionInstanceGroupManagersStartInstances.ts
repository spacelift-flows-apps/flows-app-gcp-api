...
const regionInstanceGroupManagersStartInstances: AppBlock = {
  name: "Region Instance Group Managers - Start Instances",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/regions/{region}/instanceGroupManagers/{instance_group_manager}/startInstances",
          pathParams,
          queryParams,
...
export default regionInstanceGroupManagersStartInstances;
