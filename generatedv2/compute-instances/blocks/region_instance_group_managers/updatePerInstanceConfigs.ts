...
const updatePerInstanceConfigs: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.per_instance_configs !== undefined)
          body.per_instance_configs =
            input.event.inputConfig.per_instance_configs;
...
export default updatePerInstanceConfigs;
