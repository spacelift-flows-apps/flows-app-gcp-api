      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.sourceInstance !== undefined)
          queryParams["sourceInstance"] = String(
            input.event.inputConfig.sourceInstance,
          );
        ...
        if (input.event.inputConfig.machineImageEncryptionKey !== undefined)
          body.machineImageEncryptionKey =
        ...
        if (input.event.inputConfig.totalStorageBytes !== undefined)
          body.totalStorageBytes = input.event.inputConfig.totalStorageBytes;
