...
const instanceGroupManagersResumeInstances: AppBlock = {
  name: "Instance Group Managers - Resume Instances",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/resumeInstances",
          pathParams,
          queryParams,
...
export default instanceGroupManagersResumeInstances;
