...
const instanceGroupManagersSuspendInstances: AppBlock = {
  name: "Instance Group Managers - Suspend Instances",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/suspendInstances",
          pathParams,
          queryParams,
...
export default instanceGroupManagersSuspendInstances;
