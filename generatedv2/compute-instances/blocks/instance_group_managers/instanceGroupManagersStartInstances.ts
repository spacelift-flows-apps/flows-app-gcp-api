...
const instanceGroupManagersStartInstances: AppBlock = {
  name: "Instance Group Managers - Start Instances",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/zones/{zone}/instanceGroupManagers/{instance_group_manager}/startInstances",
          pathParams,
          queryParams,
...
export default instanceGroupManagersStartInstances;
