...
const insert: AppBlock = {
  name: "Region Instance Templates - Insert",
  ...
  category: "Region Instance Templates",
  inputs: {
    default: {
      config: {
        region: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.source_instance_params !== undefined)
          body.source_instance_params =
            input.event.inputConfig.source_instance_params;
