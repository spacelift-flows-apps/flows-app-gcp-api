...
const instanceGroupManagerResizeRequestsInsert: AppBlock = {
  name: "Instance Group Manager Resize Requests - Insert",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.requestedRunDuration !== undefined)
          body.requestedRunDuration =
            input.event.inputConfig.requestedRunDuration;
        if (input.event.inputConfig.resizeBy !== undefined)
          body.resizeBy = input.event.inputConfig.resizeBy;
...
export default instanceGroupManagerResizeRequestsInsert;
