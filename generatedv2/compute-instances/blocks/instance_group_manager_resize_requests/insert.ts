  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.requested_run_duration !== undefined)
          body.requested_run_duration =
            input.event.inputConfig.requested_run_duration;
        if (input.event.inputConfig.resize_by !== undefined)
          body.resize_by = input.event.inputConfig.resize_by;
