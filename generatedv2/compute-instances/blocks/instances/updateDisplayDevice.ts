...
const updateDisplayDevice: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.enable_display !== undefined)
          body.enable_display = input.event.inputConfig.enable_display;
...
export default updateDisplayDevice;
