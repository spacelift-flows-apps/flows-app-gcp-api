    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "GET",
          pathTemplate: "/compute/v1/projects/{project}/zones/{zone}/instances",
          pathParams,
          queryParams,
        });
      ...
      type: {
        ...
        properties: {
          ...
          kind: {
            type: "string",
            description:
              "Output only. [Output Only] Type of resource. Always compute#instanceList for lists of Instance resources.",
          },
          nextPageToken: {
            type: "string",
            description:
