...
const reportHostAsFaulty: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.disruption_schedule !== undefined)
          body.disruption_schedule =
            input.event.inputConfig.disruption_schedule;
        if (input.event.inputConfig.fault_reasons !== undefined)
          body.fault_reasons = input.event.inputConfig.fault_reasons;
...
export default reportHostAsFaulty;
