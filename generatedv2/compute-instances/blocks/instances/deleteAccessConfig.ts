...
const deleteAccessConfig: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.access_config !== undefined)
          queryParams["accessConfig"] = String(
            input.event.inputConfig.access_config,
          );
...
export default deleteAccessConfig;
