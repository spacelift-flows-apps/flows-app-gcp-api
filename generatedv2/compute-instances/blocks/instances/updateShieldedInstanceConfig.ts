...
const updateShieldedInstanceConfig: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.enable_integrity_monitoring !== undefined)
          body.enable_integrity_monitoring =
            input.event.inputConfig.enable_integrity_monitoring;
        if (input.event.inputConfig.enable_secure_boot !== undefined)
          body.enable_secure_boot = input.event.inputConfig.enable_secure_boot;
        if (input.event.inputConfig.enable_vtpm !== undefined)
          body.enable_vtpm = input.event.inputConfig.enable_vtpm;
...
export default updateShieldedInstanceConfig;
