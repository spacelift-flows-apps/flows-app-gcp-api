...
const simulateMaintenanceEvent: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.with_extended_notifications !== undefined)
          queryParams["withExtendedNotifications"] = String(
            input.event.inputConfig.with_extended_notifications,
          );
...
export default simulateMaintenanceEvent;
