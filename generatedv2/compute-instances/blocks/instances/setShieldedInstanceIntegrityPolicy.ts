...
const setShieldedInstanceIntegrityPolicy: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.update_auto_learn_policy !== undefined)
          body.update_auto_learn_policy =
            input.event.inputConfig.update_auto_learn_policy;
...
export default setShieldedInstanceIntegrityPolicy;
