...
const updateAccessConfig: AppBlock = {
  name: "Instances - Update Access Config",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.external_ipv6 !== undefined)
          body.external_ipv6 = input.event.inputConfig.external_ipv6;
        if (input.event.inputConfig.external_ipv6_prefix_length !== undefined)
          body.external_ipv6_prefix_length =
            input.event.inputConfig.external_ipv6_prefix_length;
        if (input.event.inputConfig.kind !== undefined)
          body.kind = input.event.inputConfig.kind;
        if (input.event.inputConfig.name !== undefined)
          body.name = input.event.inputConfig.name;
        if (input.event.inputConfig.nat_i_p !== undefined)
          body.nat_i_p = input.event.inputConfig.nat_i_p;
        if (input.event.inputConfig.network_tier !== undefined)
          body.network_tier = input.event.inputConfig.network_tier;
        if (input.event.inputConfig.public_ptr_domain_name !== undefined)
          body.public_ptr_domain_name =
            input.event.inputConfig.public_ptr_domain_name;
        if (input.event.inputConfig.security_policy !== undefined)
          body.security_policy = input.event.inputConfig.security_policy;
        if (input.event.inputConfig.set_public_ptr !== undefined)
          body.set_public_ptr = input.event.inputConfig.set_public_ptr;
...
export default updateAccessConfig;
