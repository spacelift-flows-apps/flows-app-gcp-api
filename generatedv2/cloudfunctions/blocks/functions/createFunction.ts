  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.function !== undefined)
          request.function = input.event.inputConfig.function;
        if (input.event.inputConfig.function_id !== undefined)
          request.function_id = input.event.inputConfig.function_id;
