...
const getEkmConnection: AppBlock = {
  name: "Get Ekm Connection",
  description: `Returns metadata for a given [EkmConnection][google.cloud.kms.v1.EkmConnection].`,
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await new Promise<any>((resolve, reject) => {
          client.getEkmConnection(request, (err: any, response: any) => {
            if (err)
              reject(
                new Error(
...
export default getEkmConnection;
