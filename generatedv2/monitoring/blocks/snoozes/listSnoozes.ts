...
const listSnoozes: AppBlock = {
  name: "List Snoozes",
  description: `Lists the 'Snooze's associated with a project. Can optionally pass in 'filter', which specifies predicates to match 'Snooze's.`,
  category: "Snoozes",
  inputs: {
    default: {
      config: {
        parent: {
          name: "Parent",
          description:
            "Required. The [project](https://cloud.google.com/monitoring/api/v3#project_name) whose `Snooze`s should be listed. The format is:      projects/[PROJECT_ID_OR_NUMBER]",
          type: {
            type: "string",
            description:
              "Required. The [project](https://cloud.google.com/monitoring/api/v3#project_name) whose `Snooze`s should be listed. The format is:      projects/[PROJECT_ID_OR_NUMBER]",
      ...
      onEvent: async (input) => {
        ...
        const result = await new Promise<any>((resolve, reject) => {
          client.listSnoozes(request, (err: any, response: any) => {
            if (err)
              reject(
                new Error(
      ...
      type: {
        ...
        properties: {
          snoozes: {
            ...
            description: "`Snooze`s matching this list call.",
          },
          next_page_token: {
            type: "string",
            description:
