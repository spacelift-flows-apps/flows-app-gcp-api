...
const verifyNotificationChannel: AppBlock = {
  name: "Verify Notification Channel",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.code !== undefined)
          request.code = input.event.inputConfig.code;
...
export default verifyNotificationChannel;
