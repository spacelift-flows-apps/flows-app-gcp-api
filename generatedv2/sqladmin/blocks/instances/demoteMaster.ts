...
const inputMapping = {
  body: {
    ...
    fields: {
      demoteMasterContext: {
        name: "demote_master_context",
        fields: {
          verifyGtidConsistency: "verify_gtid_consistency",
          ...
          skipReplicationSetup: "skip_replication_setup",
        },
      },
    },
  },
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await new Promise<any>((resolve, reject) => {
          client.demoteMaster(request, (err: any, response: any) => {
            if (err)
              reject(
                new Error(
