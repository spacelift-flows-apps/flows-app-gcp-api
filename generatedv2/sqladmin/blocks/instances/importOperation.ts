        ...
        fields: {
          ...
          bakImportOptions: {
            ...
            fields: {
              ...
              bakType: "bak_type",
              stopAt: "stop_at",
              stopAtMark: "stop_at_mark",
            },
          },
          sqlImportOptions: {
            name: "sql_import_options",
            fields: {
              postgresImportOptions: {
                name: "postgres_import_options",
                fields: {
                  ifExists: "if_exists",
                },
              },
...
const importOperation: AppBlock = {
  name: "Import",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await new Promise<any>((resolve, reject) => {
          client.import(request, (err: any, response: any) => {
            if (err)
              reject(
                new Error(
