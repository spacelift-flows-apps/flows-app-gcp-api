  ...
  body: {
    ...
    fields: {
      preCheckMajorVersionUpgradeContext: {
        name: "pre_check_major_version_upgrade_context",
        fields: {
...
const preCheckMajorVersionUpgrade: AppBlock = {
    ...
    default: {
      config: {
        ...
        body: {
          ...
          type: {
            ...
            required: ["preCheckMajorVersionUpgradeContext"],
      ...
      onEvent: async (input) => {
        ...
        const result = await new Promise<any>((resolve, reject) => {
          client.preCheckMajorVersionUpgrade(
            request,
...
export default preCheckMajorVersionUpgrade;
