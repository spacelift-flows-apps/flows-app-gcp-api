    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await new Promise<any>((resolve, reject) => {
          client.destroySecretVersion(request, (err: any, response: any) => {
            if (err)
              reject(
                new Error(
...
export default destroySecretVersion;
