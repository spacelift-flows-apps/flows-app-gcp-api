...
const getSecretVersion: AppBlock = {
  ...
  description: `Gets metadata for a [SecretVersion][google.cloud.secretmanager.v1.SecretVersion]. 'projects/*/secrets/*/versions/latest' is an alias to the most recently created [SecretVersion][google.cloud.secretmanager.v1.SecretVersion].`,
...
export default getSecretVersion;
