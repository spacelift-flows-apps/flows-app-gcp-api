    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.cipherSuite !== undefined)
          body.cipherSuite = input.event.inputConfig.cipherSuite;
        ...
        if (input.event.inputConfig.detailedStatus !== undefined)
          body.detailedStatus = input.event.inputConfig.detailedStatus;
        if (input.event.inputConfig.id !== undefined)
          body.id = input.event.inputConfig.id;
        if (input.event.inputConfig.ikeVersion !== undefined)
          body.ikeVersion = input.event.inputConfig.ikeVersion;
        ...
        if (input.event.inputConfig.peerGcpGateway !== undefined)
          body.peerGcpGateway = input.event.inputConfig.peerGcpGateway;
        if (input.event.inputConfig.peerIp !== undefined)
          body.peerIp = input.event.inputConfig.peerIp;
        if (input.event.inputConfig.region !== undefined)
        ...
        if (input.event.inputConfig.sharedSecret !== undefined)
          body.sharedSecret = input.event.inputConfig.sharedSecret;
        if (input.event.inputConfig.sharedSecretHash !== undefined)
          body.sharedSecretHash = input.event.inputConfig.sharedSecretHash;
        ...
        if (input.event.inputConfig.targetVpnGateway !== undefined)
          body.targetVpnGateway = input.event.inputConfig.targetVpnGateway;
        if (input.event.inputConfig.vpnGateway !== undefined)
          body.vpnGateway = input.event.inputConfig.vpnGateway;
        if (input.event.inputConfig.vpnGatewayInterface !== undefined)
          body.vpnGatewayInterface =
