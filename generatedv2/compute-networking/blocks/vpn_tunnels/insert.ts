  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.cipher_suite !== undefined)
          body.cipher_suite = input.event.inputConfig.cipher_suite;
        ...
        if (input.event.inputConfig.detailed_status !== undefined)
          body.detailed_status = input.event.inputConfig.detailed_status;
        if (input.event.inputConfig.id !== undefined)
          body.id = input.event.inputConfig.id;
        if (input.event.inputConfig.ike_version !== undefined)
          body.ike_version = input.event.inputConfig.ike_version;
        ...
        if (input.event.inputConfig.local_traffic_selector !== undefined)
          body.local_traffic_selector =
            input.event.inputConfig.local_traffic_selector;
        if (input.event.inputConfig.name !== undefined)
          body.name = input.event.inputConfig.name;
        if (input.event.inputConfig.peer_external_gateway !== undefined)
          body.peer_external_gateway =
            input.event.inputConfig.peer_external_gateway;
        if (
          input.event.inputConfig.peer_external_gateway_interface !== undefined
        )
          body.peer_external_gateway_interface =
            input.event.inputConfig.peer_external_gateway_interface;
        if (input.event.inputConfig.peer_gcp_gateway !== undefined)
          body.peer_gcp_gateway = input.event.inputConfig.peer_gcp_gateway;
        if (input.event.inputConfig.peer_ip !== undefined)
          body.peer_ip = input.event.inputConfig.peer_ip;
        if (input.event.inputConfig.region !== undefined)
          body.region = input.event.inputConfig.region;
        if (input.event.inputConfig.remote_traffic_selector !== undefined)
          body.remote_traffic_selector =
            input.event.inputConfig.remote_traffic_selector;
        ...
        if (input.event.inputConfig.shared_secret !== undefined)
          body.shared_secret = input.event.inputConfig.shared_secret;
        if (input.event.inputConfig.shared_secret_hash !== undefined)
          body.shared_secret_hash = input.event.inputConfig.shared_secret_hash;
        if (input.event.inputConfig.status !== undefined)
          body.status = input.event.inputConfig.status;
        if (input.event.inputConfig.target_vpn_gateway !== undefined)
          body.target_vpn_gateway = input.event.inputConfig.target_vpn_gateway;
        if (input.event.inputConfig.vpn_gateway !== undefined)
          body.vpn_gateway = input.event.inputConfig.vpn_gateway;
        if (input.event.inputConfig.vpn_gateway_interface !== undefined)
          body.vpn_gateway_interface =
            input.event.inputConfig.vpn_gateway_interface;
