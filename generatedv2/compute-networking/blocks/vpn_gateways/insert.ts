  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.gateway_ip_version !== undefined)
          body.gateway_ip_version = input.event.inputConfig.gateway_ip_version;
        ...
        if (input.event.inputConfig.vpn_interfaces !== undefined)
          body.vpn_interfaces = input.event.inputConfig.vpn_interfaces;
