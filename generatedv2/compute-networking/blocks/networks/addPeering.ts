  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.auto_create_routes !== undefined)
          body.auto_create_routes = input.event.inputConfig.auto_create_routes;
        if (input.event.inputConfig.name !== undefined)
          body.name = input.event.inputConfig.name;
        if (input.event.inputConfig.network_peering !== undefined)
          body.network_peering = input.event.inputConfig.network_peering;
        if (input.event.inputConfig.peer_network !== undefined)
          body.peer_network = input.event.inputConfig.peer_network;
