  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.address_type !== undefined)
          body.address_type = input.event.inputConfig.address_type;
        ...
        if (input.event.inputConfig.ipv6_endpoint_type !== undefined)
          body.ipv6_endpoint_type = input.event.inputConfig.ipv6_endpoint_type;
        ...
        if (input.event.inputConfig.prefix_length !== undefined)
          body.prefix_length = input.event.inputConfig.prefix_length;
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate: "/compute/v1/projects/{project}/global/addresses",
          pathParams,
          queryParams,
