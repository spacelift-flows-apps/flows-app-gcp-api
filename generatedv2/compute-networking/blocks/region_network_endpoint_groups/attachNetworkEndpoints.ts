...
const attachNetworkEndpoints: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.network_endpoints !== undefined)
          body.network_endpoints = input.event.inputConfig.network_endpoints;
...
export default attachNetworkEndpoints;
