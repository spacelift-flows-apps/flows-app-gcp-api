...
const globalNetworkEndpointGroupsDetachNetworkEndpoints: AppBlock = {
  name: "Global Network Endpoint Groups - Detach Network Endpoints",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/global/networkEndpointGroups/{network_endpoint_group}/detachNetworkEndpoints",
          pathParams,
          queryParams,
...
export default globalNetworkEndpointGroupsDetachNetworkEndpoints;
