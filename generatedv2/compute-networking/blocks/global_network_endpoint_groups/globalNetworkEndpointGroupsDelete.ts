...
const globalNetworkEndpointGroupsDelete: AppBlock = {
  name: "Global Network Endpoint Groups - Delete",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "DELETE",
          pathTemplate:
            "/compute/v1/projects/{project}/global/networkEndpointGroups/{network_endpoint_group}",
          pathParams,
          queryParams,
        });
...
export default globalNetworkEndpointGroupsDelete;
