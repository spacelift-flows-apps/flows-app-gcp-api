...
const globalNetworkEndpointGroupsListNetworkEndpoints: AppBlock = {
  name: "Global Network Endpoint Groups - List Network Endpoints",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/global/networkEndpointGroups/{network_endpoint_group}/listNetworkEndpoints",
          pathParams,
          queryParams,
        });
...
export default globalNetworkEndpointGroupsListNetworkEndpoints;
