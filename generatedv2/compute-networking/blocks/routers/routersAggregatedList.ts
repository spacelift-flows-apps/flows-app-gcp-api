...
const routersAggregatedList: AppBlock = {
  name: "Routers - Aggregated List",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "GET",
          pathTemplate: "/compute/v1/projects/{project}/aggregated/routers",
          pathParams,
          queryParams,
        });
...
export default routersAggregatedList;
