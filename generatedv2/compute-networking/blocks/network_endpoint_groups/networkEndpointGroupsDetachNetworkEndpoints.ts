...
const networkEndpointGroupsDetachNetworkEndpoints: AppBlock = {
  name: "Network Endpoint Groups - Detach Network Endpoints",
...
export default networkEndpointGroupsDetachNetworkEndpoints;
