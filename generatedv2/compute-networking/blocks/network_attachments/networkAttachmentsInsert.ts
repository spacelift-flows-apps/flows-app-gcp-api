...
const networkAttachmentsInsert: AppBlock = {
  name: "Network Attachments - Insert",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.connectionEndpoints !== undefined)
          body.connectionEndpoints =
            input.event.inputConfig.connectionEndpoints;
        ...
        if (input.event.inputConfig.producerAcceptLists !== undefined)
          body.producerAcceptLists =
            input.event.inputConfig.producerAcceptLists;
        if (input.event.inputConfig.producerRejectLists !== undefined)
          body.producerRejectLists =
            input.event.inputConfig.producerRejectLists;
        if (input.event.inputConfig.region !== undefined)
...
export default networkAttachmentsInsert;
