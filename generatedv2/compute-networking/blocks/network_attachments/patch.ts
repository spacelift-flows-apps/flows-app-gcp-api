      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.network_attachment !== undefined)
          pathParams["network_attachment"] = String(
            input.event.inputConfig.network_attachment,
          );
        ...
        if (input.event.inputConfig.connection_endpoints !== undefined)
          body.connection_endpoints =
            input.event.inputConfig.connection_endpoints;
        ...
        if (input.event.inputConfig.producer_accept_lists !== undefined)
          body.producer_accept_lists =
            input.event.inputConfig.producer_accept_lists;
        if (input.event.inputConfig.producer_reject_lists !== undefined)
          body.producer_reject_lists =
            input.event.inputConfig.producer_reject_lists;
        if (input.event.inputConfig.region !== undefined)
