...
const insert: AppBlock = {
  name: "Global Public Delegated Prefixes - Insert",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.allocatable_prefix_length !== undefined)
          body.allocatable_prefix_length =
            input.event.inputConfig.allocatable_prefix_length;
        if (input.event.inputConfig.byoip_api_version !== undefined)
          body.byoip_api_version = input.event.inputConfig.byoip_api_version;
        ...
        if (
          input.event.inputConfig.enable_enhanced_ipv4_allocation !== undefined
        )
          body.enable_enhanced_ipv4_allocation =
            input.event.inputConfig.enable_enhanced_ipv4_allocation;
        ...
        if (input.event.inputConfig.is_live_migration !== undefined)
          body.is_live_migration = input.event.inputConfig.is_live_migration;
        ...
        if (input.event.inputConfig.parent_prefix !== undefined)
          body.parent_prefix = input.event.inputConfig.parent_prefix;
        if (input.event.inputConfig.public_delegated_sub_prefixs !== undefined)
          body.public_delegated_sub_prefixs =
            input.event.inputConfig.public_delegated_sub_prefixs;
