...
const setSslCertificates: AppBlock = {
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.target_https_proxy !== undefined)
          pathParams["target_https_proxy"] = String(
            input.event.inputConfig.target_https_proxy,
          );
...
export default setSslCertificates;
