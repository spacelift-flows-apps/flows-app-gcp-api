  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.proxy_header !== undefined)
          body.proxy_header = input.event.inputConfig.proxy_header;
