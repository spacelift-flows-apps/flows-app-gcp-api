...
const targetTcpProxiesDelete: AppBlock = {
  name: "Target Tcp Proxies - Delete",
    ...
    default: {
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "DELETE",
          pathTemplate:
            "/compute/v1/projects/{project}/global/targetTcpProxies/{target_tcp_proxy}",
          pathParams,
          queryParams,
        });
...
export default targetTcpProxiesDelete;
