...
const setSecurityPolicy: AppBlock = {
    ...
    default: {
      config: {
        ...
        security_policy: {
          ...
          description: "Security Policy field",
          type: {
            type: "string",
          },
          required: false,
      ...
      onEvent: async (input) => {
        ...
        const result = await computeFetch({
          ...
          method: "POST",
          pathTemplate:
            "/compute/v1/projects/{project}/regions/{region}/backendServices/{backend_service}/setSecurityPolicy",
          pathParams,
          queryParams,
...
export default setSecurityPolicy;
