  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.include_all_scopes !== undefined)
          queryParams["includeAllScopes"] = String(
            input.event.inputConfig.include_all_scopes,
          );
        ...
        if (input.event.inputConfig.service_project_number !== undefined)
          queryParams["serviceProjectNumber"] = String(
            input.event.inputConfig.service_project_number,
          );
