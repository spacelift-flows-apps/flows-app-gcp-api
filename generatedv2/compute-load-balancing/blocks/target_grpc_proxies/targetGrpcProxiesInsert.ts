...
const targetGrpcProxiesInsert: AppBlock = {
  name: "Target Grpc Proxies - Insert",
  ...
  inputs: {
    default: {
      ...
      onEvent: async (input) => {
        ...
        if (input.event.inputConfig.validateForProxyless !== undefined)
          body.validateForProxyless =
            input.event.inputConfig.validateForProxyless;
...
export default targetGrpcProxiesInsert;
